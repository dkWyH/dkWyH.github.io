! function(r, n) {
    ...
    var t = n.static,
        s = n.class,
        a = n.getset,
        o = (n.__newvec, laya.webgl.canvas.BlendMode),
        c = (laya.events.Event, laya.resource.HTMLCanvas),
        l = laya.utils.Handler,
        h = laya.webgl.utils.IndexBuffer2D,
        u = (laya.net.Loader, laya.maths.MathUtil),
        d = laya.maths.Matrix,
        m = laya.renders.Render,
        e = (laya.renders.RenderContext, laya.renders.RenderSprite, laya.webgl.shader.Shader),
        i = laya.display.Sprite,
        _ = laya.utils.Stat,
        p = laya.resource.Texture,
        f = laya.utils.Utils,
        v = laya.webgl.shader.d2.value.Value2D,
        x = laya.webgl.utils.VertexBuffer2D,
        y = laya.webgl.WebGL,
        C = (laya.webgl.WebGLContext, function() {
            function t() {
            ...
            return e.start = function(t) {
                ...
                if (this._emissionTime -= t = void 0 === t ? 1 : t, !(this._emissionTime < 0 || (this._frameTime += t, this._frameTime < this.minEmissionTime)))
        ...
        P = (s(g, "laya.particle.ParticleData"), g.Create = function(t, e, i, a) {
            var r = new g;
            r.position = e, u.scaleVector3(i, t.emitterVelocitySensitivity, g._tempVelocity);
            e = u.lerp(t.minHorizontalVelocity, t.maxHorizontalVelocity, Math.random()), i = Math.random() * Math.PI * 2;
            g._tempVelocity[0] += e * Math.cos(i), g._tempVelocity[2] += e * Math.sin(i), g._tempVelocity[1] += u.lerp(t.minVerticalVelocity, t.maxVerticalVelocity, Math.random()), r.velocity = g._tempVelocity, r.startColor = g._tempStartColor, r.endColor = g._tempEndColor;
            var n = 0;
            if (t.disableColor)
                for (n = 0; n < 4; n++) r.startColor[n] = 1, r.endColor[n] = 1;
            else if (t.colorComponentInter)
                for (n = 0; n < 4; n++) r.startColor[n] = u.lerp(t.minStartColor[n], t.maxStartColor[n], Math.random()), r.endColor[n] = u.lerp(t.minEndColor[n], t.maxEndColor[n], Math.random());
            else u.lerpVector4(t.minStartColor, t.maxStartColor, Math.random(), r.startColor), u.lerpVector4(t.minEndColor, t.maxEndColor, Math.random(), r.endColor);
            r.sizeRotation = g._tempSizeRotation;
            i = Math.random();
            r.sizeRotation[0] = u.lerp(t.minStartSize, t.maxStartSize, i), r.sizeRotation[1] = u.lerp(t.minEndSize, t.maxEndSize, i), r.sizeRotation[2] = u.lerp(t.minRotateSpeed, t.maxRotateSpeed, Math.random()), r.radius = g._tempRadius;
            i = Math.random();
            r.radius[0] = u.lerp(t.minStartRadius, t.maxStartRadius, i), r.radius[1] = u.lerp(t.minEndRadius, t.maxEndRadius, i), r.radian = g._tempRadian, r.radian[0] = u.lerp(t.minHorizontalStartRadian, t.maxHorizontalStartRadian, Math.random()), r.radian[1] = u.lerp(t.minVerticalStartRadian, t.maxVerticalStartRadian, Math.random());
            i = t.useEndRadian;
            return r.radian[2] = i ? u.lerp(t.minHorizontalEndRadian, t.maxHorizontalEndRadian, Math.random()) : r.radian[0], r.radian[3] = i ? u.lerp(t.minVerticalEndRadian, t.maxVerticalEndRadian, Math.random()) : r.radian[1], r.durationAddScale = t.ageAddScale * Math.random(), r.time = a, r
        }, t(g, ["_tempVelocity", function() {
    ...
    s(R, "laya.particle.ParticleEmitter"), R.prototype.update = function(t, e) {
        if (0 < (t /= 1e3)) {
            u.subtractVector3(e, this._previousPosition, this._tempVelocity), u.scaleVector3(this._tempVelocity, 1 / t, this._tempVelocity);
            for (var i = this._timeLeftOver + t, a = -this._timeLeftOver; i > this._timeBetweenParticles;) a += this._timeBetweenParticles, i -= this._timeBetweenParticles, u.lerpVector3(this._previousPosition, e, a / t, this._tempPosition), this._templet.addParticleArray(this._tempPosition, this._tempVelocity);
    ...
    var S = (s(V, "laya.particle.ParticleSetting"), V.checkSetting = function(t) {
        for (var e in V._defaultSetting) t.hasOwnProperty(e) || (t[e] = V._defaultSetting[e]);
        t.endVelocity = +t.endVelocity, t.gravity[0] = +t.gravity[0], t.gravity[1] = +t.gravity[1], t.gravity[2] = +t.gravity[2]
    }, t(V, ["_defaultSetting", function() {
        return this._defaultSetting = new V
    }]), V);
    ...
    var E = (s(A, "laya.particle.ParticleTemplateBase"), A.prototype.addParticleArray = function(t, e) {}, A);
    ...
    var T = function() {
            ...
            return e.getLen = function(t) {
                ...
                for (var r = this.getLen(e), n = r * a + (r * this.u_EndVelocity - r) * a * a / 2, s = this.getLen(e), o = 0, o = 0; o < 3; o++) this._position[o] = this._position[o] + e[o] / s * n * this.u_Duration, this._position[o] += this.u_Gravity[o] * i * a;
                var l = u.lerp(this.a_Radius[0], this.a_Radius[1], a),
                    h = u.lerp(this.a_Radian[0], this.a_Radian[2], a),
                    t = u.lerp(this.a_Radian[1], this.a_Radian[3], a),
                    r = Math.cos(t) * l;
                return this._position[1] += Math.sin(t) * l, this._position[0] += Math.cos(h) * r, this._position[2] += Math.sin(h) * r, new Float32Array([this._position[0], this._position[1], 0, 1])
                ...
                var a = this._color;
                return u.lerpVector4(t, e, i, a), a[3] = a[3] * i * (1 - i) * (1 - i) * 6.7, a
                ...
                t = new d, e = i / this.oSize * 2;
                t.scale(e, e), t.rotate(a), t.setTranslate(this.gl_Position[0], -this.gl_Position[1]);
                a = this.v_Color[3];
                return [this.v_Color, a, t, this.v_Color[0] * a, this.v_Color[1] * a, this.v_Color[2] * a]
            }, t
        }(),
        w = (s(z, "laya.particle.particleUtils.CMDParticle"), z.prototype.setCmds = function(t) {
    ...
    var b = (s(F, "laya.particle.particleUtils.PicTool"), F.getCanvasPic = function(t, e) {
        t = t.bitmap;
        var i = new c("2D"),
            a = i.getContext("2d");
        ...
        var r = e >> 16 & 255,
            n = e >> 8 & 255,
            s = 255 & e;
        if (m.isConchApp && a.setFilter(r / 255, n / 255, s / 255, 0), a.drawImage(t.source, 0, 0), !m.isConchApp) {
            for (var t = a.getImageData(0, 0, i.width, i.height), o = t.data, l = 0, h = o.length; l < h; l += 4) 0 != o[l + 3] && (o[l] *= r / 255, o[l + 1] *= n / 255, o[l + 2] *= s / 255);
            a.putImageData(t, 0, 0)
        }
        return i
    }, F.getRGBPic = function(t) {
        return [new p(F.getCanvasPic(t, 16711680)), new p(F.getCanvasPic(t, 65280)), new p(F.getCanvasPic(t, 255))]
    }, F);
    ...
    var D = function(t) {
        ...
        C = function() {
            ...
            s(e, "laya.particle.ParticleTemplateWebGL", E);
            var t = e.prototype;
            return t.initialize = function() {
                this._vertices = new Float32Array(this.settings.maxPartices * this._floatCountPerVertex * 4);
                for (var t, e = 0; e < this.settings.maxPartices; e++) {
                    for (var i = Math.random(), a = this.settings.textureCount ? 1 / this.settings.textureCount : 1, r = NaN, r = 0; r < this.settings.textureCount && !(i < r + a); r += a);
                    t = e * this._floatCountPerVertex * 4, this._vertices[t + 0 * this._floatCountPerVertex] = -1, this._vertices[t + 0 * this._floatCountPerVertex + 1] = -1, this._vertices[t + 0 * this._floatCountPerVertex + 2] = 0, this._vertices[t + 0 * this._floatCountPerVertex + 3] = r, this._vertices[t + +this._floatCountPerVertex] = 1, this._vertices[t + +this._floatCountPerVertex + 1] = -1, this._vertices[t + +this._floatCountPerVertex + 2] = 1, this._vertices[t + +this._floatCountPerVertex + 3] = r, this._vertices[t + 2 * this._floatCountPerVertex] = 1, this._vertices[t + 2 * this._floatCountPerVertex + 1] = 1, this._vertices[t + 2 * this._floatCountPerVertex + 2] = 1, this._vertices[t + 2 * this._floatCountPerVertex + 3] = r + a, this._vertices[t + 3 * this._floatCountPerVertex] = -1, this._vertices[t + 3 * this._floatCountPerVertex + 1] = 1, this._vertices[t + 3 * this._floatCountPerVertex + 2] = 0, this._vertices[t + 3 * this._floatCountPerVertex + 3] = r + a
                }
            }, t.loadContent = function() {}, t.update = function(t) {
                ...
                for (var t = this.settings.duration; this._firstActiveElement != this._firstNewElement;) {
                    ...
                    if (1e-4 + (a *= 1 + this._vertices[27 + e]) < t) break;
                ...
                if ((i = i >= this.settings.maxPartices ? 0 : i) !== this._firstRetiredElement) {
                    for (var a = P.Create(this.settings, t, e, this._currentTime), r = this._firstFreeElement * this._floatCountPerVertex * 4, n = 0; n < 4; n++) {
                        for (var s = 0, o = 0, s = 0, o = 4; s < 3; s++) this._vertices[r + n * this._floatCountPerVertex + o + s] = a.position[s];
        ...
        N = function() {
            ...
            s(e, "laya.particle.ParticleTemplateCanvas", E);
            var t = e.prototype;
            return t._textureLoaded = function(t) {
            ...
            }, t._createAParticleData = function(t, e) {
                this.canvasShader.u_EndVelocity = this.settings.endVelocity, this.canvasShader.u_Gravity = this.settings.gravity, this.canvasShader.u_Duration = this.settings.duration, t = P.Create(this.settings, t, e, 0), this.canvasShader.a_Position = t.position, this.canvasShader.a_Velocity = t.velocity, this.canvasShader.a_StartColor = t.startColor, this.canvasShader.a_EndColor = t.endColor, this.canvasShader.a_SizeRotation = t.sizeRotation, this.canvasShader.a_Radius = t.radius, this.canvasShader.a_Radian = t.radian, this.canvasShader.a_AgeAddScale = t.durationAddScale, this.canvasShader.oSize = this.textureWidth;
                for (var e = new w, i = 0, a = this.settings.duration / (1 + t.durationAddScale), r = [], i = 0; i < a; i += this.step) r.push(this.canvasShader.getData(i));
                return e.id = this.particleList.length, this.particleList.push(e), e.setCmds(r), e
                ...
                if (void 0 === t && (t = 1), this._ready)
                    for (var e, i = this.activeParticles, a = this.deadParticles, r = 0, t = i.length, n = 0, s = this.iList, r = t - 1; - 1 < r; r--)(n = s[(e = i[r]).id]) >= e.maxIndex ? (n = 0, i.splice(r, 1), a.push(e)) : n += 1, s[e.id] = n
            ...
            }, t.noColorRender = function(t, e, i) {
                ...
                for (t.translate(e, i), s = t.ctx.globalAlpha, l = 0; l < h; l++) n = _[(a = o[l]).id], (a = a.cmds[n]) && ((r = a[1]) <= .01 || (t.setAlpha(s * r), t.drawTextureWithTransform(this.texture, c, u, d, m, a[2], 1)));
                t.setAlpha(s), t.translate(-e, -i)
            }, t.canvasRender = function(t, e, i) {
                var a, r, n, s, o = this.activeParticles,
                    l = 0,
                    h = o.length,
                    c = this.pX,
                    ...
                    _ = this.textureList,
                    p = this.iList;
                for (t.translate(e, i), n = t.ctx.globalAlpha, s = t.ctx.globalCompositeOperation, t.blendMode("lighter"), l = 0; l < h; l++) r = p[(a = o[l]).id], (a = a.cmds[r]) && (a[1] <= .01 || (t.save(), t.transformByMatrix(a[2]), .01 < a[3] && (t.setAlpha(n * a[3]), t.drawTexture(_[0], c, u, d, m)), .01 < a[4] && (t.setAlpha(n * a[4]), t.drawTexture(_[1], c, u, d, m)), .01 < a[5] && (t.setAlpha(n * a[5]), t.drawTexture(_[2], c, u, d, m)), t.restore()));
                t.setAlpha(n), t.translate(-e, -i), t.blendMode(s)
            }, e.changeTexture = function(t, e, i) {
                return (e = e || []).length = 0, i && i.disableColor ? e.push(t, t, t) : f.copyArray(e, b.getRGBPic(t)), e
            }, e
        }(),
        L = function(i) {
            function a(t) {
                this._vertexBuffer2D = null, this._indexBuffer2D = null, this.x = 0, this.y = 0, this._blendFn = null, this._startTime = 0, this.sv = new M, a.__super.call(this, t);
                var e = this;
                n.loader.load(this.settings.textureName, l.create(null, function(t) {
                    t.bitmap.enableMerageInAtlas = !1, e.texture = t
                })), this.sv.u_Duration = this.settings.duration, this.sv.u_Gravity = this.settings.gravity, this.sv.u_EndVelocity = this.settings.endVelocity, this._blendFn = o.fns[t.blendState], this.initialize(), this._vertexBuffer = this._vertexBuffer2D = x.create(-1, 35048), this._indexBuffer = this._indexBuffer2D = h.create(35044), this.loadContent()
            }
            s(a, "laya.particle.ParticleTemplate2D", i);
            var t = a.prototype;
            return n.imps(t, {
    ...
    function B() {
        ...
        s(i, "laya.particle.Particle2D", e);
        var t = i.prototype;
        t.load = function(t) {
            n.loader.load(t, l.create(this, this.setParticleSetting), null, "json")
        }, t.setParticleSetting = function(e) {
            var i = this;
            if (!e) return this.stop();
            if (S.checkSetting(e), r.ConchParticleTemplate2D && !m.isWebGL || (this.customRenderEnable = !0), m.isWebGL) this._particleTemplate = new L(e), this.graphics._saveToCmd(m.context._drawParticle, [this._particleTemplate]);
            else {
                if (m.isConchApp && r.ConchParticleTemplate2D) {
                    this._particleTemplate = new ConchParticleTemplate2D;
                    var a = this;
                    return n.loader.load(e.textureName, l.create(null, function(t) {
                        a._particleTemplate.texture = t, a._particleTemplate.settings = e, m.isConchNode ? a.graphics.drawParticle(a._particleTemplate) : a.graphics._saveToCmd(m.context._drawParticle, [i._particleTemplate])
                    })), this._emitter = {
                        start: function() {}
                ...
                this._particleTemplate = this._canvasTemplate = new N(e)
            }
            this._emitter ? this._emitter.template = this._particleTemplate : this._emitter = new D(this._particleTemplate), this.autoPlay && (this.emitter.start(), this.play())
        }, t.play = function() {
            ...
            m.isWebGL && (this._matrix4[0] = t.ctx._curMat.a, this._matrix4[1] = t.ctx._curMat.b, this._matrix4[4] = t.ctx._curMat.c, this._matrix4[5] = t.ctx._curMat.d, this._matrix4[12] = t.ctx._curMat.tx, this._matrix4[13] = t.ctx._curMat.ty, this._particleTemplate.sv.u_mmat = this._matrix4), this._canvasTemplate && this._canvasTemplate.render(t, e, i)
            ...
            this.load(t)
        }), a(0, t, "emitter", function() {
            return this._emitter
        })
    }(i);
    var I = (s(H, "laya.particle.shader.ParticleShader", e), t(H, ["vs", function() {
    ...
    function H() {
        H.__super.call(this, H.vs, H.ps, "ParticleShader")
    }

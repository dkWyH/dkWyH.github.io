! function(n, g) {
    ...
    var s = g.static,
        h = g.class,
        o = g.getset,
        i = (g.__newvec, laya.display.Animation),
        l = laya.utils.Browser,
        p = laya.utils.ClassUtils,
        e = laya.filters.ColorFilter,
        r = laya.utils.Ease,
        a = laya.events.Event,
        c = (laya.events.EventDispatcher, laya.display.css.Font),
        _ = laya.display.FrameAnimation,
        t = laya.display.Graphics,
        u = laya.utils.Handler,
        d = laya.net.HttpRequest,
        f = laya.display.Input,
        m = laya.net.Loader,
        y = laya.net.LocalStorage,
        v = (laya.display.Node, laya.maths.Point),
        C = laya.maths.Rectangle,
        b = laya.renders.Render,
        S = laya.display.Sprite,
        x = (laya.display.Stage, laya.display.Text),
        w = laya.resource.Texture,
        B = laya.utils.TimeLine,
        I = laya.utils.Tween,
        k = laya.utils.Utils,
        L = laya.utils.WeakObject;
    g.interface("laya.ui.IItem"), g.interface("laya.ui.ISelect"), g.interface("laya.ui.IRender"), g.interface("laya.ui.IComponent"), g.interface("laya.ui.IBox", "IComponent");
    var M = (h(T, "laya.ui.LayoutStyle"), s(T, ["EMPTY", function() {
    ...
    var z = (h(P, "laya.ui.Styles"), P.labelColor = "#000000", P.buttonStateNum = 3, P.scrollBarMinNum = 15, P.scrollBarDelayTime = 500, s(P, ["defaultSizeGrid", function() {
    ...
    function P() {}
    var H = (h(D, "laya.ui.UIUtils"), D.fillArray = function(t, i, e) {
        var s = t.concat();
        if (i)
        ...
        return s
    }, D.toColor = function(t) {
        return k.toHexColor(t)
    }, D.gray = function(t, i) {
        (i = void 0 === i ? !0 : i) ? D.addFilter(t, D.grayFilter): D.clearFilter(t, e)
    }, D.addFilter = function(t, i) {
        var e = t.filters || [];
        e.push(i), t.filters = e
    }, D.clearFilter = function(t, i) {
        var e = t.filters;
        if (null != e && 0 < e.length) {
            for (var s = e.length - 1; - 1 < s; s--) {
                var n = e[s];
                g.__typeof(n, i) && e.splice(s, 1)
            }
            t.filters = e
        }
    }, D._getReplaceStr = function(t) {
        return D.escapeSequence[t]
    }, D.adptString = function(t) {
        return t.replace(/\\(\w)/g, D._getReplaceStr)
    }, D.getBindFun = function(t) {
        var i, e = D._funMap.get(t);
        return null == e && (i = (i = '"' + t + '"').replace(/^"\${|}"$/g, "").replace(/\${/g, '"+').replace(/}/g, '+"'), e = g._runScript("(function(data){if(data==null)return;with(data){try{\nreturn " + i + "\n}catch(e){}}})"), D._funMap.set(t, e)), e
    }, s(D, ["grayFilter", function() {
    ...
    function D() {}
    var A = (h(O, "UIConfig"), O.touchScrollEnable = !0, O.mouseWheelEnable = !0, O.showButtons = !0, O.popupBgColor = "#000000", O.popupBgAlpha = .5, O.closeDialogOnSide = !0, O);
        ...
        return t.destroy = function() {
            ...
            if (t && t.bitmap) {
                ...
                if (!s || n === i && h === e) this.clear(), this.drawTexture(t, this._offset ? this._offset[0] : 0, this._offset ? this._offset[1] : 0, i, e);
                    ...
                    t.$_GID || (t.$_GID = k.getGID());
                    var o = t.$_GID + "." + i + "." + e + "." + s.join(".");
                    if (k.isOKCmdList(L.I.get(o))) return void(this.cmds = L.I.get(o));
                    this.clear();
                    var r = s[0],
                        a = s[1],
                        l = s[2],
    ...
    var G, X = function(i) {
            function t() {
                this._comXml = null, this._dataSource = null, this._toolTip = null, this._tag = null, this._disabled = !1, this._gray = !1, this.layoutEnabled = !0, t.__super.call(this), this._layout = M.EMPTY, this.preinitialize(), this.createChildren(), this.initialize()
            }
            h(t, "laya.ui.Component", i);
            var e = t.prototype;
            return g.imps(e, {
                "laya.ui.IComponent": !0
            }), e.destroy = function(t) {
                i.prototype.destroy.call(this, t = void 0 === t ? !0 : t), this._dataSource = this._layout = null, this._tag = null, this._toolTip = null
            }, e.preinitialize = function() {}, e.createChildren = function() {}, e.initialize = function() {}, e.callLater = function(t, i) {
                g.timer.callLater(this, t, i)
            }, e.runCallLater = function(t) {
                g.timer.runCallLater(this, t)
                ...
                var t, i = this._layout;
                isNaN(i.anchorX) || (this.pivotX = i.anchorX * this.width), !this.layoutEnabled || (t = this.parent) && (isNaN(i.centerX) ? isNaN(i.left) ? isNaN(i.right) || (this.x = Math.round(t.width - this.displayWidth - i.right + this.pivotX * this.scaleX)) : (this.x = Math.round(i.left + this.pivotX * this.scaleX), isNaN(i.right) || (this.width = (t._width - i.left - i.right) / (this.scaleX || .01))) : this.x = Math.round(.5 * (t.width - this.displayWidth) + i.centerX + this.pivotX * this.scaleX))
            }, e.resetLayoutY = function() {
                var t, i = this._layout;
                isNaN(i.anchorY) || (this.pivotY = i.anchorY * this.height), !this.layoutEnabled || (t = this.parent) && (isNaN(i.centerY) ? isNaN(i.top) ? isNaN(i.bottom) || (this.y = Math.round(t.height - this.displayHeight - i.bottom + this.pivotY * this.scaleY)) : (this.y = Math.round(i.top + this.pivotY * this.scaleY), isNaN(i.bottom) || (this.height = (t._height - i.top - i.bottom) / (this.scaleY || .01))) : this.y = Math.round(.5 * (t.height - this.displayHeight) + i.centerY + this.pivotY * this.scaleY))
            }, e.onMouseOver = function(t) {
                g.stage.event("showtip", this._toolTip)
            }, e.onMouseOut = function(t) {
                g.stage.event("hidetip", this._toolTip)
            }, e._childChanged = function(t) {
                this.callLater(this.changeSize), i.prototype._childChanged.call(this, t)
            }, o(0, e, "displayWidth", function() {
                return this.width * this.scaleX
            }), o(0, e, "width", function() {
                return this._width || this.measureWidth
            }, function(t) {
                ...
                return t
            }), o(0, e, "displayHeight", function() {
                return this.height * this.scaleY
            }), o(0, e, "height", function() {
                return this._height || this.measureHeight
            }, function(t) {
            ...
            }), o(0, e, "scaleY", i.prototype._$get_scaleY, function(t) {
                g.superGet(S, this, "scaleY") != t && (g.superSet(S, this, "scaleY", t), this.callLater(this.changeSize), this._layout.enable && this.resetLayoutY())
            }), o(0, e, "measureHeight", function() {
                var t = 0;
                this.commitMeasure();
                for (var i = this.numChildren - 1; - 1 < i; i--) {
                    var e = this.getChildAt(i);
                ...
                return t
            }), o(0, e, "scaleX", i.prototype._$get_scaleX, function(t) {
                g.superGet(S, this, "scaleX") != t && (g.superSet(S, this, "scaleX", t), this.callLater(this.changeSize), this._layout.enable && this.resetLayoutX())
            }), o(0, e, "top", function() {
                return this._layout.top
            }, function(t) {
                t != this._layout.top && (this.getLayout().top = t, this._setLayoutEnabled(!0)), this.resetLayoutY()
            }), o(0, e, "bottom", function() {
        ...
        E = function() {
            function t() {
                this.lockLayer = null, this.popupEffect = function(t) {
                    t.scale(1, 1), I.from(t, {
                        ...
                        scaleX: 0,
                        scaleY: 0
                    }, 300, r.backOut, u.create(this, this.doOpen, [t]))
                    ...
                    I.to(t, {
                        ...
                        scaleX: 0,
                        scaleY: 0
                    }, 300, r.strongOut, u.create(this, this.doClose, [t, i]))
                }, t.__super.call(this), this.maskLayer = new S, this.popupEffectHandler = new u(this, this.popupEffect), this.closeEffectHandler = new u(this, this.closeEffect), this.mouseEnabled = this.maskLayer.mouseEnabled = !0, this.zOrder = 1e3, g.stage.addChild(this), g.stage.on("resize", this, this._onResize), A.closeDialogOnSide && this.maskLayer.on("click", this, this._closeOnSide), this._onResize(null)
            }
            h(t, "laya.ui.DialogManager", S);
            var i = t.prototype;
            return i._closeOnSide = function() {
                ...
                this.lockLayer || (this.lockLayer = new V, this.lockLayer.mouseEnabled = !0, this.lockLayer.size(g.stage.width, g.stage.height)), this.lockLayer.removeChildren(), t && (t.centerX = t.centerY = 0, this.lockLayer.addChild(t))
            }, i._onResize = function(t) {
                var i = this.maskLayer.width = g.stage.width,
                    e = this.maskLayer.height = g.stage.height;
                this.lockLayer && this.lockLayer.size(i, e), this.maskLayer.graphics.clear(), this.maskLayer.graphics.drawRect(0, 0, i, e, A.popupBgColor), this.maskLayer.alpha = A.popupBgAlpha;
                for (var s = this.numChildren - 1; - 1 < s; s--) {
                    var n = this.getChildAt(s);
                    n.popupCenter && this._centerDialog(n)
                }
            }, i._centerDialog = function(t) {
                t.x = Math.round((g.stage.width - t.width >> 1) + t.pivotX), t.y = Math.round((g.stage.height - t.height >> 1) + t.pivotY)
            }, i.open = function(t, i, e) {
                void 0 === e && (e = !1), (i = void 0 === i ? !1 : i) && this._closeAll(), t.popupCenter && this._centerDialog(t), this.addChild(t), (t.isModal || this._$P.hasZorder) && this.timer.callLater(this, this._checkMask), e && null != t.popupEffect ? t.popupEffect.runWith(t) : this.doOpen(t), this.event("open")
            }, i.doOpen = function(t) {
                t.onOpened()
            }, i.lock = function(t) {
                this.lockLayer && (t ? this.addChild(this.lockLayer) : this.lockLayer.removeSelf())
            }, i.close = function(t, i, e) {
                (e = void 0 === e ? !1 : e) && null != t.closeEffect ? t.closeEffect.runWith([t, i]) : this.doClose(t, i), this.event("close")
            }, i.doClose = function(t, i) {
        ...
        R = function(i) {
            ...
            return t.destroy = function(t) {
                ...
                this.destroy(!0), g.loader.clearRes(this._skin)
            ...
            }), o(0, t, "dataSource", i.prototype._$get_dataSource, function(t) {
                "string" == typeof(this._dataSource = t) ? this.skin = t: g.superSet(X, this, "dataSource", t)
            }), o(0, t, "measureHeight", function() {
                return this._bitmap.height
            }), o(0, t, "skin", function() {
                return this._skin
            }, function(t) {
                this._skin != t && ((this._skin = t) ? (t = m.getRes(t)) ? (this.source = t, this.onCompResize()) : g.loader.load(this._skin, u.create(this, this.setSource, [this._skin]), null, "image", 1, !0, this._group) : this.source = null)
            }), o(0, t, "group", function() {
                return this._group
            }, function(t) {
                ...
                this._bitmap.sizeGrid = H.fillArray(z.defaultSizeGrid, t, Number)
            }), o(0, t, "measureWidth", function() {
                return this._bitmap.width
            }), o(0, t, "width", i.prototype._$get_width, function(t) {
                g.superSet(X, this, "width", t), this._bitmap.width = 0 == t ? 1e-7 : t
            }), o(0, t, "height", i.prototype._$get_height, function(t) {
                g.superSet(X, this, "height", t), this._bitmap.height = 0 == t ? 1e-7 : t
            }), e
        }(X),
        V = function(t) {
            function i() {
            ...
            return g.imps(e, {
                "laya.ui.IBox": !0
            }), o(0, e, "dataSource", t.prototype._$get_dataSource, function(t) {
        ...
        W = function(i) {
            function e(t, i) {
                this.toggle = !1, this._bitmap = null, this._text = null, this._strokeColors = null, this._state = 0, this._selected = !1, this._skin = null, this._autoSize = !0, this._sources = null, this._clickHandler = null, this._stateChanged = !1, e.__super.call(this), this._labelColors = z.buttonLabelColors, this._stateNum = z.buttonStateNum, void 0 === i && (i = ""), this.skin = t, this.label = i
            }
            h(e, "laya.ui.Button", i);
            var t = e.prototype;
            return g.imps(t, {
                "laya.ui.ISelect": !0
            }), t.destroy = function(t) {
                i.prototype.destroy.call(this, t = void 0 === t ? !0 : t), this._bitmap && this._bitmap.destroy(), this._text && this._text.destroy(t), this._bitmap = null, this._text = null, this._clickHandler = null, this._labelColors = this._sources = this._strokeColors = null
            }, t.createChildren = function() {
                ...
                if (t) {
                    ...
                    var s = t.$_GID + "-" + this._stateNum,
                        n = L.I.get(s);
                    if (n = !k.isOkTextureList(n) ? null : n) this._sources = n;
                    else {
                        if (this._sources = [], 1 === this._stateNum) this._sources.push(t);
                        else
                            for (var h = 0; h < this._stateNum; h++) this._sources.push(w.createFromTexture(t, 0, e * h, i, e));
            ...
            }, o(0, t, "labelStrokeColor", function() {
            ...
            }), o(0, t, "state", function() {
                return this._state
            }, function(t) {
                this._state != t && (this._state = t, this._setStateChanged())
            }), o(0, t, "text", function() {
                return this.createText(), this._text
            }), o(0, t, "stateNum", function() {
                return this._stateNum
            }, function(t) {
                "string" == typeof t && (t = parseInt(t)), this._stateNum != t && (this._stateNum = t < 1 ? 1 : 3 < t ? 3 : t, this.callLater(this.changeClips))
            }), o(0, t, "strokeColors", function() {
                return this._strokeColors ? this._strokeColors.join(",") : ""
            }, function(t) {
                this._strokeColors = H.fillArray(z.buttonLabelColors, t, String), this._setStateChanged()
            }), o(0, t, "labelColors", function() {
                return this._labelColors.join(",")
            }, function(t) {
                this._labelColors = H.fillArray(z.buttonLabelColors, t, String), this._setStateChanged()
            }), o(0, t, "measureWidth", function() {
                ...
                g.superSet(X, this, "width", t), this._autoSize && (this._bitmap.width = t, this._text && (this._text.width = t))
            }), o(0, t, "height", i.prototype._$get_height, function(t) {
                g.superSet(X, this, "height", t), this._autoSize && (this._bitmap.height = t, this._text && (this._text.height = t))
            }), o(0, t, "dataSource", i.prototype._$get_dataSource, function(t) {
                "number" == typeof(this._dataSource = t) || "string" == typeof t ? this.label = t + "" : g.superSet(X, this, "dataSource", t)
            }), o(0, t, "iconOffset", function() {
        ...
        $ = function(i) {
            function s(t, i, e) {
                this._sources = null, this._bitmap = null, this._skin = null, this._clipX = 1, this._clipY = 1, this._clipWidth = 0, this._clipHeight = 0, this._autoPlay = !1, this._interval = 50, this._complete = null, this._isPlaying = !1, this._index = 0, this._clipChanged = !1, this._group = null, this._toIndex = -1, s.__super.call(this), void 0 === e && (e = 1), this._clipX = i = void 0 === i ? 1 : i, this._clipY = e, this.skin = t
            }
            h(s, "laya.ui.Clip", i);
            var t = s.prototype;
            return t.destroy = function(t) {
                ...
                var t;
                this._clipChanged = !1, this._skin && ((t = m.getRes(this._skin)) ? this.loadComplete(this._skin, t) : g.loader.load(this._skin, u.create(this, this.loadComplete, [this._skin])))
                ...
                if (t === this._skin && i) {
                    var e = this._clipWidth || Math.ceil(i.sourceWidth / this._clipX),
                        ...
                        n = this._skin + e + s,
                        t = L.I.get(n);
                    if (t = !k.isOkTextureList(t) ? null : t) this._sources = t;
                    else {
                        this._sources = [];
                        for (var h = 0; h < this._clipY; h++)
                            for (var o = 0; o < this._clipX; o++) this._sources.push(w.createFromTexture(i, e * o, s * h, e, s));
                        L.I.set(n, this._sources)
                    }
                    this.index = this._index, this.event("loaded"), this.onCompResize()
                }
            }, t.play = function(t, i) {
                void 0 === t && (t = 0), void 0 === i && (i = -1), this._isPlaying = !0, this.index = t, this._toIndex = i, this._index++, g.timer.loop(this.interval, this, this._loop), this.on("display", this, this._onDisplay), this.on("undisplay", this, this._onDisplay)
            }, t._loop = function() {
                ...
                t && this._skin && m.setGroup(this._skin, t), this._group = t
            }), o(0, t, "clipHeight", function() {
                return this._clipHeight
            }, function(t) {
                this._clipHeight = t, this._setClipChanged()
            }), o(0, t, "width", i.prototype._$get_width, function(t) {
                g.superSet(X, this, "width", t), this._bitmap.width = t
            }), o(0, t, "height", i.prototype._$get_height, function(t) {
                g.superSet(X, this, "height", t), this._bitmap.height = t
            }), o(0, t, "measureWidth", function() {
                return this.runCallLater(this.changeClip), this._bitmap.width
            }), o(0, t, "measureHeight", function() {
                return this.runCallLater(this.changeClip), this._bitmap.height
            }), o(0, t, "index", function() {
                return this._index
            }, function(t) {
                this._index = t, this._bitmap && this._sources && (this._bitmap.source = this._sources[t]), this.event("change")
            }), o(0, t, "autoPlay", function() {
                return this._autoPlay
            }, function(t) {
                this._autoPlay != t && ((this._autoPlay = t) ? this.play() : this.stop())
            }), o(0, t, "isPlaying", function() {
                return this._isPlaying
            }, function(t) {
                this._isPlaying = t
            }), o(0, t, "dataSource", i.prototype._$get_dataSource, function(t) {
                "number" == typeof(this._dataSource = t) && Math.floor(t) == t || "string" == typeof t ? this.index = parseInt(t) : g.superSet(X, this, "dataSource", t)
            }), o(0, t, "bitmap", function() {
                return this._bitmap
            }), s
        }(X),
        U = function(i) {
            ...
            h(t, "laya.ui.ColorPicker", i);
            var e = t.prototype;
            return e.destroy = function(t) {
                i.prototype.destroy.call(this, t = void 0 === t ? !0 : t), this._colorPanel && this._colorPanel.destroy(t), this._colorButton && this._colorButton.destroy(t), this._colorPanel = null, this._colorTiles = null, this._colorBlock = null, this._colorInput = null, this._colorButton = null, this._colors = null, this.changeHandler = null
            }, e.createChildren = function() {
                this.addChild(this._colorButton = new W), this._colorPanel = new V, this._colorPanel.size(230, 166), this._colorPanel.addChild(this._colorTiles = new S), this._colorPanel.addChild(this._colorBlock = new S), this._colorPanel.addChild(this._colorInput = new f)
                ...
                for (var i = [0, 3355443, 6710886, 10066329, 13421772, 16777215, 16711680, 65280, 255, 16776960, 65535, 16711935], e = 0; e < 12; e++)
                    for (var s = 0; s < 20; s++) {
                        var n = H.toColor(0 === s ? i[e] : 1 === s ? 0 : 51 * (((3 * e + s / 6) % 3 << 0) + 3 * (e / 6 << 0)) << 16 | s % 6 * 51 << 8 | (e << 0) % 6 * 51);
                        this._colors.push(n);
                        var h = s * this._gridSize,
                            o = e * this._gridSize;
                        t.drawRect(h, o, this._gridSize, this._gridSize, n, "#000000")
                    }
            }, e.onColorButtonClick = function(t) {
                this._colorPanel.parent ? this.close() : this.open()
            }, e.open = function() {
                var t = this.localToGlobal(new v),
                    i = t.x + this._colorPanel.width <= g.stage.width ? t.x : g.stage.width - this._colorPanel.width,
                    e = (e = t.y + this._colorButton.height) + this._colorPanel.height <= g.stage.height ? e : t.y - this._colorPanel.height;
                this._colorPanel.pos(i, e), this._colorPanel.zOrder = 1001, g._currentStage.addChild(this._colorPanel), g.stage.on("mousedown", this, this.removeColorBox)
            }, e.close = function() {
                g.stage.off("mousedown", this, this.removeColorBox), this._colorPanel.removeSelf()
                ...
                return this._colors[20 * t + i]
            }, e.drawBlock = function(t) {
                var i = this._colorBlock.graphics;
                i.clear(), i.drawRect(0, 0, 50, 20, t || "#ffffff", this._borderColor), t || i.drawLine(0, 0, 50, 20, "#ff0000")
            ...
            }, o(0, e, "inputBgColor", function() {
                return this._inputBgColor
            }, function(t) {
                this._inputBgColor = t, this._setPanelChanged()
            }), o(0, e, "selectedColor", function() {
                return this._selectedColor
            }, function(t) {
                this._selectedColor != t && (this._selectedColor = this._colorInput.text = t, this.drawBlock(t), this.changeColor(), this.changeHandler && this.changeHandler.runWith(this._selectedColor), this.event("change", a.EMPTY.setTo("change", this, this)))
            }), o(0, e, "skin", function() {
                return this._colorButton.skin
            }, function(t) {
                this._colorButton.skin = t, this.changeColor()
            }), o(0, e, "bgColor", function() {
                return this._bgColor
            }, function(t) {
                this._bgColor = t, this._setPanelChanged()
            }), o(0, e, "borderColor", function() {
                return this._borderColor
            }, function(t) {
                this._borderColor = t, this._setPanelChanged()
            }), o(0, e, "inputColor", function() {
        ...
        F = function(i) {
            function e(t, i) {
                this._visibleNum = 6, this._button = null, this._list = null, this._isOpen = !1, this._itemSize = 12, this._labels = [], this._selectedIndex = -1, this._selectHandler = null, this._itemHeight = NaN, this._listHeight = NaN, this._listChanged = !1, this._itemChanged = !1, this._scrollBarSkin = null, this._isCustomList = !1, this.itemRender = null, e.__super.call(this), this._itemColors = z.comboBoxItemColors, this.skin = t, this.labels = i
            }
            h(e, "laya.ui.ComboBox", i);
            var t = e.prototype;
            return t.destroy = function(t) {
                i.prototype.destroy.call(this, t = void 0 === t ? !0 : t), this._button && this._button.destroy(t), this._list && this._list.destroy(t), this._button = null, this._list = null, this._itemColors = null, this._labels = null, this._selectHandler = null
            }, t.createChildren = function() {
                this.addChild(this._button = new W), this._button.text.align = "left", this._button.labelPadding = "0,0,0,5", this._button.on("mousedown", this, this.onButtonMouseDown)
            }, t._createList = function() {
                this._list = new et, this._scrollBarSkin && (this._list.vScrollBarSkin = this._scrollBarSkin), this._setListEvent(this._list)
            }, t._setListEvent = function(t) {
                this._list.selectEnable = !0, this._list.on("mousedown", this, this.onListDown), this._list.mouseHandler = u.create(this, this.onlistItemMouse, null, !1), this._list.scrollBar && this._list.scrollBar.on("mousedown", this, this.onScrollBarDown)
                ...
                var e = t.type;
                "mouseover" === e || "mouseout" === e ? this._isCustomList || (!(t = this._list.getCell(i)) || (t = t.getChildByName("label")) && ("mouseover" === e ? (t.bgColor = this._itemColors[0], t.color = this._itemColors[1]) : (t.bgColor = null, t.color = this._itemColors[2]))) : "click" === e && (this.selectedIndex = i, this.isOpen = !1)
                ...
                var t;
                this._itemChanged = !1, this._listHeight = 0 < this._labels.length ? Math.min(this._visibleNum, this._labels.length) * this._itemHeight : this._itemHeight, this._isCustomList || ((t = this._list.graphics).clear(), t.drawRect(0, 0, this.width - 1, this._listHeight, this._itemColors[4], this._itemColors[3]));
                ...
                g.stage.off("mousedown", this, this.removeList), g.stage.off("mousewheel", this, this._onStageMouseWheel), this.isOpen = !1
            }, o(0, t, "selectedIndex", function() {
                return this._selectedIndex
            }, function(t) {
                this._selectedIndex != t && (this._selectedIndex = t, 0 < this._labels.length ? this.changeSelected() : this.callLater(this.changeSelected), this.event("change", [a.EMPTY.setTo("change", this, this)]), this._selectHandler && this._selectHandler.runWith(this._selectedIndex))
            }), o(0, t, "measureHeight", function() {
                ...
                g.superSet(X, this, "width", t), this._button.width = this._width, this._itemChanged = !0, this._listChanged = !0
            }), o(0, t, "selectedLabel", function() {
            ...
            }), o(0, t, "itemColors", function() {
                return String(this._itemColors)
            }, function(t) {
                this._itemColors = H.fillArray(this._itemColors, t, String), this._listChanged = !0
            }), o(0, t, "itemSize", function() {
                return this._itemSize
            }, function(t) {
                this._itemSize = t, this._listChanged = !0
            }), o(0, t, "scrollBar", function() {
                return this.list.scrollBar
            }), o(0, t, "isOpen", function() {
                return this._isOpen
            }, function(t) {
                var i;
                this._isOpen != t && (this._isOpen = t, this._button.selected = this._isOpen, this._isOpen ? (this._list || this._createList(), this._listChanged && !this._isCustomList && this.changeList(), this._itemChanged && this.changeItem(), t = (t = (i = this.localToGlobal(v.TEMP.setTo(0, 0))).y + this._button.height) + this._listHeight <= g.stage.height ? t : i.y - this._listHeight, this._list.pos(i.x, t), this._list.zOrder = 1001, g._currentStage.addChild(this._list), g.stage.once("mousedown", this, this.removeList), g.stage.on("mousewheel", this, this._onStageMouseWheel), this._list.selectedIndex = this._selectedIndex) : this._list && this._list.removeSelf())
            }), o(0, t, "scrollBarSkin", function() {
                ...
                "number" == typeof(this._dataSource = t) && Math.floor(t) == t || "string" == typeof t ? this.selectedIndex = parseInt(t) : t instanceof Array ? this.labels = t.join(",") : g.superSet(X, this, "dataSource", t)
            }), o(0, t, "labelColors", function() {
                ...
                this._button.text.padding = H.fillArray(z.labelPadding, t, Number)
            }), o(0, t, "labelSize", function() {
        ...
        j = function(i) {
            ...
            return t.destroy = function(t) {
                ...
                this.addChild(this.slider = new q), this.addChild(this.upButton = new W), this.addChild(this.downButton = new W)
            }, t.initialize = function() {
                ...
                t = t.currentTarget === this.upButton;
                this.slide(t), g.timer.once(z.scrollBarDelayTime, this, this.startLoop, [t]), g.stage.once("mouseup", this, this.onStageMouseUp)
            }, t.startLoop = function(t) {
                g.timer.frameLoop(1, this, this.slide, [t])
            }, t.slide = function(t) {
                t ? this.value -= this._scrollSize : this.value += this._scrollSize
            }, t.onStageMouseUp = function(t) {
                g.timer.clear(this, this.startLoop), g.timer.clear(this, this.slide)
                ...
                this._clickOnly = !0, this._lastOffset = 0, this._checkElastic = !1, this._lastPoint || (this._lastPoint = new v), this._lastPoint.setTo(g.stage.mouseX, g.stage.mouseY), g.timer.clear(this, this.tweenMove), I.clearTween(this), g.stage.once("mouseup", this, this.onStageMouseUp2), g.stage.once("mouseout", this, this.onStageMouseUp2), g.timer.frameLoop(1, this, this.loop)
            }, t.loop = function() {
                var t = g.stage.mouseY,
                    i = g.stage.mouseX;
                if (this._lastOffset = this.isVertical ? t - this._lastPoint.y : i - this._lastPoint.x, this._clickOnly) {
                    if (!(1 < Math.abs(this._lastOffset * (this.isVertical ? g.stage._canvasTransform.getScaleY() : g.stage._canvasTransform.getScaleX())))) return;
                ...
                if (g.stage.off("mouseup", this, this.onStageMouseUp2), g.stage.off("mouseout", this, this.onStageMouseUp2), g.timer.clear(this, this.loop), !(this._clickOnly && this._value >= this.min && this._value <= this.max))
                    if (this._target.mouseEnabled = !0, this._isElastic) this._value < this.min ? I.to(this, {
                        value: this.min
                    }, this.elasticBackTime, r.sineOut, u.create(this, this.elasticOver)) : this._value > this.max && I.to(this, {
                        value: this.max
                    }, this.elasticBackTime, r.sineOut, u.create(this, this.elasticOver));
                    else if (this._offsets) {
                    this._offsets.length < 1 && (this._offsets[0] = this.isVertical ? g.stage.mouseY - this._lastPoint.y : g.stage.mouseX - this._lastPoint.x);
                    for (var i, e = 0, s = Math.min(this._offsets.length, 3), n = 0; n < s; n++) e += this._offsets[this._offsets.length - 1 - n];
                    this._lastOffset = e / s, (e = Math.abs(this._lastOffset)) < 2 ? this.event("end") : (60 < e && (this._lastOffset = 0 < this._lastOffset ? 60 : -60), i = Math.round(Math.abs(this.elasticDistance * (this._lastOffset / 240))), g.timer.frameLoop(1, this, this.tweenMove, [i]))
                }
                ...
                var i = NaN;
                0 < t && (0 < this._lastOffset && this.value <= this.min ? (this._isElastic = !0, i = .5 * -(this.min - t - this.value), this._lastOffset > i && (this._lastOffset = i)) : this._lastOffset < 0 && this.value >= this.max && (this._isElastic = !0, i = .5 * -(this.max + t - this.value), this._lastOffset < i && (this._lastOffset = i))), this.value -= this._lastOffset, Math.abs(this._lastOffset) < 1 && (g.timer.clear(this, this.tweenMove), this._isElastic ? this._value < this.min ? I.to(this, {
                    value: this.min
                }, this.elasticBackTime, r.sineOut, u.create(this, this.elasticOver)) : this._value > this.max ? I.to(this, {
                    value: this.max
                }, this.elasticBackTime, r.sineOut, u.create(this, this.elasticOver)) : this.elasticOver() : (this.event("end"), !this.hide && this.autoHide && I.to(this, {
                    alpha: 0
                }, 500)))
            }, t.stopScroll = function() {
                this.onStageMouseUp2(null), g.timer.clear(this, this.tweenMove), I.clearTween(this)
            }, o(0, t, "measureHeight", function() {
            ...
            }), o(0, t, "scrollSize", function() {
                return this._scrollSize
            }, function(t) {
                this._scrollSize = t
            }), o(0, t, "dataSource", i.prototype._$get_dataSource, function(t) {
                "number" == typeof(this._dataSource = t) || "string" == typeof t ? this.value = Number(t) : g.superSet(X, this, "dataSource", t)
            }), o(0, t, "thumbPercent", function() {
                return this._thumbPercent
            }, function(t) {
                this.runCallLater(this.changeScrollBar), this.runCallLater(this.changeSize), this._thumbPercent = t = 1 <= t ? .99 : t, this.scaleBar && (this.slider.isVertical ? this.slider.bar.height = Math.max(this.slider.height * t, z.scrollBarMinNum) : this.slider.bar.width = Math.max(this.slider.width * t, z.scrollBarMinNum))
            }), o(0, t, "target", function() {
                return this._target
            }, function(t) {
            ...
            }), o(0, t, "touchScrollEnable", function() {
                return this._touchScrollEnable
            }, function(t) {
                this._touchScrollEnable = t, this.target = this._target
            }), o(0, t, "mouseWheelEnable", function() {
        ...
        q = function(i) {
            ...
            h(e, "laya.ui.Slider", i);
            var t = e.prototype;
            return t.destroy = function(t) {
                i.prototype.destroy.call(this, t = void 0 === t ? !0 : t), this._bg && this._bg.destroy(t), this._bar && this._bar.destroy(t), this._progress && this._progress.destroy(t), this._bg = null, this._bar = null, this._progress = null, this.changeHandler = null
            }, t.createChildren = function() {
                this.addChild(this._bg = new R), this.addChild(this._bar = new W)
            }, t.initialize = function() {
                ...
                this._globalSacle || (this._globalSacle = new v), this._globalSacle.setTo(this.globalScaleX || .01, this.globalScaleY || .01), this._maxMove = this.isVertical ? this.height - this._bar.height : this.width - this._bar.width, this._tx = g.stage.mouseX, this._ty = g.stage.mouseY, g.stage.on("mousemove", this, this.mouseMove), g.stage.once("mouseup", this, this.mouseUp), g.stage.once("mouseout", this, this.mouseUp), this.showValueText()
            }, t.showValueText = function() {
                var t;
                this.showLabel && (t = laya.ui.Slider.label, this.addChild(t), t.textField.changeText(this._value + ""), this.isVertical ? (t.x = this._bar.x + 20, t.y = .5 * (this._bar.height - t.height) + this._bar.y) : (t.y = this._bar.y - 20, t.x = .5 * (this._bar.width - t.width) + this._bar.x))
            }, t.hideValueText = function() {
                laya.ui.Slider.label && laya.ui.Slider.label.removeSelf()
            }, t.mouseUp = function(t) {
                g.stage.off("mousemove", this, this.mouseMove), g.stage.off("mouseup", this, this.mouseUp), g.stage.off("mouseout", this, this.mouseUp), this.sendChangeEvent("changed"), this.hideValueText()
            }, t.mouseMove = function(t) {
                var i = this._value;
                this.isVertical ? (this._bar.y += (g.stage.mouseY - this._ty) / this._globalSacle.y, this._bar.y > this._maxMove ? this._bar.y = this._maxMove : this._bar.y < 0 && (this._bar.y = 0), this._value = this._bar.y / this._maxMove * (this._max - this._min) + this._min, this._progress && (this._progress.height = this._bar.y + .5 * this._bar.height)) : (this._bar.x += (g.stage.mouseX - this._tx) / this._globalSacle.x, this._bar.x > this._maxMove ? this._bar.x = this._maxMove : this._bar.x < 0 && (this._bar.x = 0), this._value = this._bar.x / this._maxMove * (this._max - this._min) + this._min, this._progress && (this._progress.width = this._bar.x + .5 * this._bar.width)), this._tx = g.stage.mouseX, this._ty = g.stage.mouseY;
                ...
                this.event(t = void 0 === t ? "change" : t), this.changeHandler && this.changeHandler.runWith(this._value)
                ...
                t = this._max - this._min;
                0 === t && (t = 1), this.isVertical ? (this._bar.y = (this._value - this._min) / t * (this.height - this._bar.height), this._progress && (this._progress.height = this._bar.y + .5 * this._bar.height)) : (this._bar.x = (this._value - this._min) / t * (this.width - this._bar.width), this._progress && (this._progress.width = this._bar.x + .5 * this._bar.width))
                ...
                this._skin != t && (this._skin = t, this._bg.skin = this._skin, this._bar.skin = this._skin.replace(".png", "$bar.png"), t = this._skin.replace(".png", "$progress.png"), m.getRes(t) && (this._progress || (this.addChild(this._progress = new R), this._progress.sizeGrid = this._bar.sizeGrid, this.setChildIndex(this._progress, 1)), this._progress.skin = t), this.setBarPoint(), this.callLater(this.changeValue))
            }), o(0, t, "allowClickBack", function() {
                ...
                var i;
                this._value != t && (i = this._value, this._value = t, this.changeValue(), this._value != i && this.sendChangeEvent())
            }), o(0, t, "dataSource", i.prototype._$get_dataSource, function(t) {
                "number" == typeof(this._dataSource = t) || "string" == typeof t ? this.value = Number(t) : g.superSet(X, this, "dataSource", t)
            }), o(0, t, "bar", function() {
                return this._bar
            }), s(e, ["label", function() {
                return this.label = new J
            }]), e
        }(X),
        J = function(i) {
            function e(t) {
                this._tf = null, e.__super.call(this), void 0 === t && (t = ""), c.defaultColor = z.labelColor, this.text = t
            }
            h(e, "laya.ui.Label", i);
            var t = e.prototype;
            return t.destroy = function(t) {
                i.prototype.destroy.call(this, t = void 0 === t ? !0 : t), this._tf = null
            }, t.createChildren = function() {
                this.addChild(this._tf = new x)
            }, t.changeText = function(t) {
                this._tf.changeText(t)
            }, o(0, t, "padding", function() {
                return this._tf.padding.join(",")
            }, function(t) {
                this._tf.padding = H.fillArray(z.labelPadding, t, Number)
            }), o(0, t, "bold", function() {
                return this._tf.bold
            }, function(t) {
                this._tf.bold = t
            }), o(0, t, "align", function() {
            ...
            }), o(0, t, "italic", function() {
                return this._tf.italic
            }, function(t) {
                this._tf.italic = t
            }), o(0, t, "wordWrap", function() {
                ...
                "number" == typeof(this._dataSource = t) || "string" == typeof t ? this.text = t + "" : g.superSet(X, this, "dataSource", t)
            }), o(0, t, "color", function() {
                return this._tf.color
            }, function(t) {
                this._tf.color = t
            }), o(0, t, "valign", function() {
                return this._tf.valign
            }, function(t) {
                this._tf.valign = t
            }), o(0, t, "leading", function() {
                return this._tf.leading
            }, function(t) {
                this._tf.leading = t
            }), o(0, t, "fontSize", function() {
                return this._tf.fontSize
            }, function(t) {
                this._tf.fontSize = t
            }), o(0, t, "bgColor", function() {
                return this._tf.bgColor
            }, function(t) {
                this._tf.bgColor = t
            }), o(0, t, "borderColor", function() {
                return this._tf.borderColor
            }, function(t) {
                this._tf.borderColor = t
            }), o(0, t, "stroke", function() {
                return this._tf.stroke
            }, function(t) {
                this._tf.stroke = t
            }), o(0, t, "strokeColor", function() {
                return this._tf.strokeColor
            }, function(t) {
                this._tf.strokeColor = t
            }), o(0, t, "textField", function() {
                return this._tf
            }), o(0, t, "measureWidth", function() {
                ...
                return this._width || this._tf.text ? g.superGet(X, this, "width") : 0
            }, function(t) {
                g.superSet(X, this, "width", t), this._tf.width = t
            }), o(0, t, "height", function() {
                return this._height || this._tf.text ? g.superGet(X, this, "height") : 0
            }, function(t) {
                g.superSet(X, this, "height", t), this._tf.height = t
            }), o(0, t, "overflow", function() {
                return this._tf.overflow
            }, function(t) {
                this._tf.overflow = t
            }), o(0, t, "underline", function() {
                return this._tf.underline
            }, function(t) {
                this._tf.underline = t
            }), o(0, t, "underlineColor", function() {
        ...
        K = function(i) {
            ...
            h(e, "laya.ui.ProgressBar", i);
            var t = e.prototype;
            return t.destroy = function(t) {
                i.prototype.destroy.call(this, t = void 0 === t ? !0 : t), this._bg && this._bg.destroy(t), this._bar && this._bar.destroy(t), this._bg = this._bar = null, this.changeHandler = null
            }, t.createChildren = function() {
                this.addChild(this._bg = new R), this.addChild(this._bar = new R), this._bar._bitmap.autoCacheCmd = !1
            }, t.changeValue = function() {
                var t, i, e;
                this.sizeGrid ? (e = this.sizeGrid.split(","), t = Number(e[3]), i = Number(e[1]), e = (this.width - t - i) * this._value, this._bar.width = t + i + e, this._bar.visible = this._bar.width > t + i) : this._bar.width = this.width * this._value
            }, o(0, t, "measureHeight", function() {
                ...
                g.superSet(X, this, "height", t), this._bg.height = this._height, this._bar.height = this._height
            }), o(0, t, "bar", function() {
                return this._bar
            }), o(0, t, "value", function() {
                return this._value
            }, function(t) {
                this._value != t && (this._value = t = 1 < t ? 1 : t < 0 ? 0 : t, this.callLater(this.changeValue), this.event("change"), this.changeHandler && this.changeHandler.runWith(t))
            }), o(0, t, "bg", function() {
                return this._bg
            }), o(0, t, "sizeGrid", function() {
                return this._bg.sizeGrid
                ...
                g.superSet(X, this, "width", t), this._bg.width = this._width, this.callLater(this.changeValue)
            }), o(0, t, "dataSource", i.prototype._$get_dataSource, function(t) {
                "number" == typeof(this._dataSource = t) || "string" == typeof t ? this.value = Number(t) : g.superSet(X, this, "dataSource", t)
            }), e
        }(X),
        Z = (function() {
            function i() {
                this._tipBox = null, this._tipText = null, this._defaultTipHandler = null, i.__super.call(this), this._tipBox = new X, this._tipBox.addChild(this._tipText = new x), this._tipText.x = this._tipText.y = 5, this._tipText.color = i.tipTextColor, this._defaultTipHandler = this._showDefaultTip, g.stage.on("showtip", this, this._onStageShowTip), g.stage.on("hidetip", this, this._onStageHideTip), this.zOrder = 1100
            }
            h(i, "laya.ui.TipManager", X);
            var t = i.prototype;
            t._onStageHideTip = function(t) {
                g.timer.clear(this, this._showTip), this.closeAll(), this.removeSelf()
            }, t._onStageShowTip = function(t) {
                g.timer.once(i.tipDelay, this, this._showTip, [t], !0)
            }, t._showTip = function(t) {
                var i;
                "string" == typeof t ? (i = String(t), Boolean(i) && this._defaultTipHandler(i)) : t instanceof laya.utils.Handler ? t.run() : "function" == typeof t && t.apply(), g.stage.on("mousemove", this, this._onStageMouseMove), g.stage.on("mousedown", this, this._onStageMouseDown), this._onStageMouseMove(null)
            }, t._onStageMouseDown = function(t) {
                this.closeAll()
            }, t._onStageMouseMove = function(t) {
                this._showToStage(this, i.offsetX, i.offsetY)
            }, t._showToStage = function(t, i, e) {
                void 0 === i && (i = 0), void 0 === e && (e = 0);
                var s = t.getBounds();
                t.x = g.stage.mouseX + i, t.y = g.stage.mouseY + e, t.x + s.width > g.stage.width && (t.x -= s.width + i), t.y + s.height > g.stage.height && (t.y -= s.height + e)
            }, t.closeAll = function() {
                g.timer.clear(this, this._showTip), g.stage.off("mousemove", this, this._onStageMouseMove), g.stage.off("mousedown", this, this._onStageMouseDown), this.removeChildren()
            }, t.showDislayTip = function(t) {
                this.addChild(t), this._showToStage(this), g._currentStage.addChild(this)
            }, t._showDefaultTip = function(t) {
                this._tipText.text = t;
                t = this._tipBox.graphics;
                t.clear(), t.drawRect(0, 0, this._tipText.width + 10, this._tipText.height + 10, i.tipBackColor), this.addChild(this._tipBox), this._showToStage(this), g._currentStage.addChild(this)
            }, o(0, t, "defaultTipHandler", function() {
            ...
            function e(t) {
                this.advsListArr = [], this.resUrl = "https://unioncdn.layabox.com/config/iconlist.json", this._data = [], this._resquestTime = 36e4, this._appid = null, this._appCodeImgStr = null, this._playIndex = 0, this._lunboTime = 5e3, e.__super.call(this), this._http = new l.window.XMLHttpRequest, this.skin = t, this.init(), this.size(120, 120)
            }
            h(e, "laya.ui.AdvImage", i);
            var t = e.prototype;
            t.init = function() {
                l.onMiniGame && this.isSupportJump ? (g.timer.loop(this._resquestTime, this, this.onGetAdvsListData), this.onGetAdvsListData(), this.initEvent()) : this.visible = !1
                ...
                var t = this;
                l.onMiniGame && this.isSupportJump && wx.navigateToMiniProgram({
                    appId: this._appid,
                    path: "",
                    extraData: "",
                    envVersion: "release",
                ...
                this.visible = !1, this.onLunbo(), g.timer.loop(this._lunboTime, this, this.onLunbo)
            }, t.onLunbo = function() {
                ...
                var i = this,
                    ...
                    t = this.resUrl + "?" + t;
                this._http.open("get", t, !0), this._http.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), this._http.responseType = "text", this._http.onerror = function(t) {
                    i._onError(t)
                }, this._http.onload = function(t) {
                    i._onLoad(t)
                }, this._http.send(null)
            }, t.randRange = function(t, i) {
                ...
                try {
                    this._data = this._http.response || this._http.responseText, this._data = JSON.parse(this._data), this.advsListArr = this._data.list, this._appid = this._data.appid, this._appCodeImgStr = this._data.qrcode, this.updateAdvsInfo(), this.revertAdvsData()
                } catch (t) {
                ...
                void 0 === t && (t = !0), i.prototype.destroy.call(this, !0), g.timer.clear(this, this.onLunbo), g.timer.clear(this, this.onGetAdvsListData), this.clear()
            }, o(0, t, "isSupportJump", function() {
            ...
            h(f, "laya.ui.View", V);
            var t = f.prototype;
            return t.createView = function(t) {
                if (t.animations && !this._idMap && (this._idMap = {}), f.createComp(t, this, this), t.animations) {
                    for (var i, e, s = [], n = t.animations, h = 0, o = n.length, h = 0; h < o; h++) {
                        switch (i = new _, e = n[h], i._setUp(this._idMap, e), (this[e.name] = i)._setControlNode(this), e.action) {
                            case 1:
                                i.play(0, !1);
                                break;
                            case 2:
            ...
            }, t.onEvent = function(t, i) {}, t.loadUI = function(t) {
                t = f.uiMap[t];
                t && this.createView(t)
            }, t.destroy = function(t) {
                ...
                for (var t in f.uiClassMap) p.regClass(t, f.uiClassMap[t])
            }, f.createComp = function(t, i, e, s) {
                if (!(i = i || f.getCompInstance(t))) return console.warn("can not create:" + t.type), null;
                var n = t.child;
                if (n)
                    for (var h = i instanceof laya.ui.List, o = 0, r = n.length; o < r; o++) {
                        var a, l, c = n[o];
                        !i.hasOwnProperty("itemRender") || "render" != c.props.name && "render" !== c.props.renderType ? "Graphic" == c.type ? p.addGraphicsToSprite(c, i) : p.isDrawType(c.type) ? p.addGraphicToSprite(c, i, !0) : (h ? (l = f.createComp(c, null, e, a = []), a.length && (l._$bindData = a)) : l = f.createComp(c, null, e, s), "Script" == c.type ? "owner" in l ? l.owner = i : "target" in l && (l.target = i) : "mask" == c.props.renderType || "mask" == c.props.name ? i.mask = l : l instanceof laya.display.Sprite && i.addChild(l)) : i.itemRender = c
                    }
                var u, _ = t.props;
                for (u in _) {
                    var d = _[u];
                    f.eventDic[u] ? d && e && i.on(u, e, e.onEvent, [d]) : f.setCompValue(i, u, d, e, s)
                }
                return g.__typeof(i, "laya.ui.IItem") && i.initItems(), t.compId && e && e._idMap && (e._idMap[t.compId] = i), i
            }, f.setCompValue = function(t, i, e, s, n) {
                if ("string" == typeof e && -1 < e.indexOf("${"))
                    if (f._sheet || (f._sheet = p.getClass("laya.data.Table")), f._sheet) {
                        if (n) n.push(t, i, e);
                        else if (s) {
                            -1 == e.indexOf("].") && (e = e.replace(".", "[0]."));
                            var h, o = new u(t, i, e);
                            o.exe(s);
                            for (var r = e.replace(/\[.*?\]\./g, "."); null != (h = f._parseWatchData.exec(r));) {
                                for (var a = h[1]; null != (l = f._parseKeyWord.exec(a));) {
                                    var l = l[0],
                                        c = s._watchMap[l] || (s._watchMap[l] = []);
                                    c.push(o), f._sheet.I.notifer.on(l, s, s.changeData, [l])
                                }(c = s._watchMap[a] || (s._watchMap[a] = [])).push(o), f._sheet.I.notifer.on(a, s, s.changeData, [a])
                            }
                        }
                    } else console.warn("Can not find class Sheet");
                else "var" === i && s ? s[e] = t : "onClick" == i ? (n = g._runScript("(function(){" + e + "})"), t.on("click", s, n)) : t[i] = "true" === e || "false" !== e && e
            }, f.getCompInstance = function(t) {
                var i = t.props ? t.props.runtime : null,
                    i = i ? f.viewClassMap[i] || f.uiClassMap[i] || g.__classmap[i] : f.uiClassMap[t.type];
                return t.props && t.props.hasOwnProperty("renderType") && "instance" == t.props.renderType ? i.instance : i ? new i : null
            }, f.regComponent = function(t, i) {
                f.uiClassMap[t] = i, p.regClass(t, i)
                ...
                f._regs(), h(t, ""), t.prototype.exe = function(t) {
                    var i = H.getBindFun(this.value);
        ...
        Q = function(t) {
            function e(t, i) {
                e.__super.call(this, t, i = void 0 === i ? "" : i)
            }
            h(e, "laya.ui.CheckBox", t);
            var i = e.prototype;
            ...
            }, o(0, i, "dataSource", t.prototype._$get_dataSource, function(t) {
                "boolean" == typeof(this._dataSource = t) ? this.selected = t: "string" == typeof t ? this.selected = "true" === t : g.superSet(W, this, "dataSource", t)
            }), e
        }(W),
        tt = function() {
            function t() {
                this._space = 0, this._align = "none", this._itemChanged = !1, t.__super.call(this)
            }
            h(t, "laya.ui.LayoutBox", V);
            var i = t.prototype;
            ...
            }, o(0, i, "space", function() {
                return this._space
            }, function(t) {
                this._space = t, this._setItemChanged()
            }), o(0, i, "align", function() {
                return this._align
            }, function(t) {
            ...
            return t.createChildren = function() {
                ...
                if (this._sources && (this._valueArr && (this.graphics.clear(!0), t = this._sources[0]))) {
                    ...
                    for (var s = 0, n = this._valueArr.length; s < n; s++) {
                        ...
                        this.sources[h] && (t = this.sources[h], i ? this.graphics.drawTexture(t, e + s * (t.sourceWidth + this.spaceX), 0, t.sourceWidth, t.sourceHeight) : this.graphics.drawTexture(t, 0 + e, s * (t.sourceHeight + this.spaceY), t.sourceWidth, t.sourceHeight))
                    }
                ...
                g.superSet($, this, "height", t), this.callLater(this.changeValue)
            }), o(0, t, "direction", function() {
                ...
                this._valueArr = t += "", this.callLater(this.changeValue)
            }), o(0, t, "width", i.prototype._$get_width, function(t) {
                g.superSet($, this, "width", t), this.callLater(this.changeValue)
            }), o(0, t, "spaceX", function() {
                return this._spaceX
            }, function(t) {
                this._spaceX = t, "horizontal" === this._direction && this.callLater(this.changeValue)
            }), o(0, t, "spaceY", function() {
                return this._spaceY
            }, function(t) {
        ...
        et = function(t) {
            ...
            return g.imps(e, {
                ...
                if (this.cacheContent) {
                    var r = new V;
                    r.cacheAsBitmap = !0, r.pos((this._isVertical ? 0 : t) * h, (this._isVertical ? t : 0) * o), this._content.addChild(r), this._content.optimizeScrollRect = !0, s = r
                } else {
                ...
                for (var u = t; u < e; u++)
                    for (var _ = 0; _ < i; _++)(n = a && a.length ? a.pop() : this.createItem()).x = (this._isVertical ? _ : u) * h - s.x, n.y = (this._isVertical ? u : _) * o - s.y, n.name = "item" + (u * i + _), s.addChild(n), this.addCell(n)
            }, e.createItem = function() {
                var t = [],
                    i = "function" == typeof this._itemRender ? new this._itemRender : Z.createComp(this._itemRender, null, null, t);
                if (0 == t.length && i._watchMap) {
                    var e, s = i._watchMap;
                    for (e in s)
                        for (var n = s[e], h = 0; h < n.length; h++) {
                            var o = n[h];
                ...
                this._content.width = t, this._content.height = i, !this._scrollBar && 0 == this._offset.x && 0 == this._offset.y || (this._content.scrollRect || (this._content.scrollRect = new C), this._content.scrollRect.setTo(-this._offset.x, -this._offset.y, t, i), this._content.scrollRect = this._content.scrollRect), this.event("resize")
                ...
                t = t.getChildByName("selectBox");
                t && (this.selectEnable = !0, t.visible = i, t.index = e)
                ...
                if (this.cacheContent) this._createdLine - n < (a = s + 1) && (this._createItems(this._createdLine, e, this._createdLine + a), this.renderItems(this._createdLine * e, 0), this._createdLine += a);
                else {
                    var h, o, r = n * e,
                        a = 0;
                    r > this._startIndex ? (a = r - this._startIndex, o = this._startIndex + e * (s + 1), this._isMoved = h = !0) : r < this._startIndex && (a = this._startIndex - r, o = this._startIndex - 1, this._isMoved = !(h = !1));
                    for (var l = 0; l < a; l++) {
                        var c, u = h ? (c = this._cells.shift(), this._cells[this._cells.length] = c, o + l) : (c = this._cells.pop(), this._cells.unshift(c), o - l),
                            _ = Math.floor(u / e) * this._cellSize;
                        this._isVertical ? c.y = _ : c.x = _, this.renderItem(c, u)
                    }
                    this._startIndex = r, this.changeSelectStatus()
                }
                r = this._content.scrollRect;
                this._isVertical ? (r.y = i - this._offset.y, r.x = -this._offset.x) : (r.y = -this._offset.y, r.x = i - this._offset.x), this._content.scrollRect = r
            }, e.posCell = function(t, i) {
                var e;
                this._scrollBar && (e = this._isVertical ? this.repeatX : this.repeatY, this._isVertical ? this.repeatY : this.repeatX, e = Math.floor(i / e) * this._cellSize, this._isVertical ? t.y = e : t.x = e)
                ...
                for (var e = t = void 0 === t ? 0 : t, s = (i = void 0 === i ? 0 : i) || this._cells.length; e < s; e++) this.renderItem(this._cells[e], this._startIndex + e);
                ...
                var i;
                this._scrollBar ? (i = this._isVertical ? this.repeatX : this.repeatY, this._scrollBar.value = Math.floor(t / i) * this._cellSize) : this.startIndex = t
            }, e.tweenTo = function(t, i, e) {
                var s;
                void 0 === i && (i = 200), this._scrollBar ? (s = this._isVertical ? this.repeatX : this.repeatY, I.to(this._scrollBar, {
                    value: Math.floor(t / s) * this._cellSize
                }, i, null, e, 0, !0)) : (this.startIndex = t, e && e.run())
            }, e._setCellChanged = function() {
                this._cellChanged || (this._cellChanged = !0, this.callLater(this.changeCells))
            }, e.commitMeasure = function() {
                this.runCallLater(this.changeCells)
            }, o(0, e, "cacheAs", t.prototype._$get_cacheAs, function(t) {
                g.superSet(V, this, "cacheAs", t), this._scrollBar && (this._$P.cacheAs = null, "none" !== t ? this._scrollBar.on("start", this, this.onScrollStart) : this._scrollBar.off("start", this, this.onScrollStart))
            }), o(0, e, "content", function() {
                return this._content
            }), o(0, e, "height", t.prototype._$get_height, function(t) {
                t != this._height && (g.superSet(V, this, "height", t), this._setCellChanged())
            }), o(0, e, "itemRender", function() {
            ...
            }), o(0, e, "width", t.prototype._$get_width, function(t) {
                t != this._width && (g.superSet(V, this, "width", t), this._setCellChanged())
            }), o(0, e, "repeatY", function() {
                return 0 < this._repeatY ? this._repeatY : 0 < this._repeatY2 ? this._repeatY2 : 1
            }, function(t) {
                this._repeatY = t, this._setCellChanged()
            }), o(0, e, "spaceX", function() {
                return this._spaceX
            }, function(t) {
                this._spaceX = t, this._setCellChanged()
            }), o(0, e, "spaceY", function() {
                return this._spaceY
            }, function(t) {
                this._spaceY = t, this._setCellChanged()
            }), o(0, e, "selectedIndex", function() {
                return this._selectedIndex
            }, function(t) {
            ...
            }), o(0, e, "selectedItem", function() {
                return -1 != this._selectedIndex ? this._array[this._selectedIndex] : null
            }, function(t) {
                this.selectedIndex = this._array.indexOf(t)
            }), o(0, e, "length", function() {
                return this._array ? this._array.length : 0
            }), o(0, e, "selection", function() {
                return this.getCell(this._selectedIndex)
            }, function(t) {
                this.selectedIndex = this._startIndex + this._cells.indexOf(t)
            }), o(0, e, "startIndex", function() {
                return this._startIndex
            }, function(t) {
                this._startIndex = 0 < t ? t : 0, this.callLater(this.renderItems)
            }), o(0, e, "array", function() {
                return this._array
            }, function(t) {
                this.runCallLater(this.changeCells), this._array = t || [];
                var i, e = this._array.length;
                this.totalPage = Math.ceil(e / (this.repeatX * this.repeatY)), this._selectedIndex = this._selectedIndex < e ? this._selectedIndex : e - 1, this.startIndex = this._startIndex, this._scrollBar && (this._scrollBar.stopScroll(), i = this._isVertical ? this.repeatX : this.repeatY, t = this._isVertical ? this.repeatY : this.repeatX, i = Math.ceil(e / i), 1 < (0 < this._cellOffset ? this.totalPage + 1 : this.totalPage) ? (this._scrollBar.scrollSize = this._cellSize, this._scrollBar.thumbPercent = t / i, this._scrollBar.setScroll(0, (i - t) * this._cellSize + this._cellOffset, this._scrollBar.value)) : this._scrollBar.setScroll(0, 0, 0), this._scrollBar.target = this._content)
            }), o(0, e, "dataSource", t.prototype._$get_dataSource, function(t) {
                "number" == typeof(this._dataSource = t) && Math.floor(t) == t || "string" == typeof t ? this.selectedIndex = parseInt(t) : t instanceof Array ? this.array = t : g.superSet(V, this, "dataSource", t)
            }), o(0, e, "cells", function() {
                return this.runCallLater(this.changeCells), this._cells
            }), i
        }(V),
        st = (h(nt, "laya.ui.HScrollBar", G = j), nt.prototype.initialize = function() {
            G.prototype.initialize.call(this), this.slider.isVertical = !1
        }, nt);

    function nt() {
        nt.__super.call(this)
    }
    var ht = function(t) {
            function i() {
            ...
            return e.destroy = function(t) {
                ...
                return this._content.removeChildren(t = void 0 === t ? 0 : t, i = void 0 === i ? 2147483647 : i), this._setScrollChanged(), this
                ...
                var e = this._content;
                e.width = t, e.height = i, e.scrollRect || (e.scrollRect = new C), e.scrollRect.setTo(0, 0, t, i), e.scrollRect = e.scrollRect
            }, e.onScrollBarChange = function(t) {
                var i, e = this._content.scrollRect;
                e && (i = Math.round(t.value), t.isVertical ? e.y = i : e.x = i, this._content.scrollRect = e)
                ...
                this._$P.cacheAs || (this._$P.cacheAs = g.superGet(V, this, "cacheAs")), g.superSet(V, this, "cacheAs", "none"), this._hScrollBar && this._hScrollBar.once("end", this, this.onScrollEnd), this._vScrollBar && this._vScrollBar.once("end", this, this.onScrollEnd)
            }, e.onScrollEnd = function() {
                g.superSet(V, this, "cacheAs", this._$P.cacheAs)
            }, e._setScrollChanged = function() {
                this._scrollChanged || (this._scrollChanged = !0, this.callLater(this.changeScroll))
            }, o(0, e, "numChildren", function() {
                return this._content.numChildren
            }), o(0, e, "hScrollBarSkin", function() {
                return this._hScrollBar ? this._hScrollBar.skin : null
            }, function(t) {
                null == this._hScrollBar && (laya.display.Node.prototype.addChild.call(this, this._hScrollBar = new st), this._hScrollBar.on("change", this, this.onScrollBarChange, [this._hScrollBar]), this._hScrollBar.target = this._content, this._setScrollChanged()), this._hScrollBar.skin = t
            }), o(0, e, "contentWidth", function() {
                for (var t = 0, i = this._content.numChildren - 1; - 1 < i; i--) var e = this._content.getChildAt(i),
                    t = Math.max(e.x + e.width * e.scaleX, t);
                return t
            }), o(0, e, "contentHeight", function() {
                for (var t = 0, i = this._content.numChildren - 1; - 1 < i; i--) var e = this._content.getChildAt(i),
                    t = Math.max(e.y + e.height * e.scaleY, t);
                return t
            }), o(0, e, "width", t.prototype._$get_width, function(t) {
                g.superSet(V, this, "width", t), this._setScrollChanged()
            }), o(0, e, "hScrollBar", function() {
                return this._hScrollBar
            }), o(0, e, "content", function() {
                return this._content
            }), o(0, e, "height", t.prototype._$get_height, function(t) {
                g.superSet(V, this, "height", t), this._setScrollChanged()
            }), o(0, e, "vScrollBarSkin", function() {
                return this._vScrollBar ? this._vScrollBar.skin : null
            }, function(t) {
                null == this._vScrollBar && (laya.display.Node.prototype.addChild.call(this, this._vScrollBar = new _t), this._vScrollBar.on("change", this, this.onScrollBarChange, [this._vScrollBar]), this._vScrollBar.target = this._content, this._setScrollChanged()), this._vScrollBar.skin = t
            }), o(0, e, "vScrollBar", function() {
                return this._vScrollBar
            }), o(0, e, "cacheAs", t.prototype._$get_cacheAs, function(t) {
                g.superSet(V, this, "cacheAs", t), this._$P.cacheAs = null, "none" !== t ? (this._hScrollBar && this._hScrollBar.on("start", this, this.onScrollStart), this._vScrollBar && this._vScrollBar.on("start", this, this.onScrollStart)) : (this._hScrollBar && this._hScrollBar.off("start", this, this.onScrollStart), this._vScrollBar && this._vScrollBar.off("start", this, this.onScrollStart))
            }), i
        }(V),
        ot = (h(rt, "laya.ui.HSlider", q), rt);

    function rt(t) {
        rt.__super.call(this, t), this.isVertical = !1
    }
    var at = function(t) {
            function e(t, i) {
            ...
            return g.imps(i, {
                ...
                return e.name = "item" + s, this.addChild(e), this.initItems(), i && 0 < s ? (t = this._items[s - 1], "horizontal" == this._direction ? e.x = t.x + t.width + this._space : e.y = t.y + t.height + this._space) : i && (e.x = 0, e.y = 0), s
                ...
                if (-1 != e) {
                    ...
                    this.initItems(), -1 < this._selectedIndex && (e = 0, e = this._selectedIndex < this._items.length ? this._selectedIndex : this._selectedIndex - 1, this._selectedIndex = -1, this.selectedIndex = e)
                }
                ...
                for (var t = this._items.length = 0; t < 1e4; t++) {
                    ...
                    if (null == i) break;
                    this._items.push(i), i.selected = t === this._selectedIndex, i.clickHandler = u.create(this, this.itemClick, [t], !1)
                }
            ...
            }, o(0, i, "labelStrokeColor", function() {
            ...
            }), o(0, i, "items", function() {
                return this._items
            }), o(0, i, "selection", function() {
                ...
                "number" == typeof(this._dataSource = t) && Math.floor(t) == t || "string" == typeof t ? this.selectedIndex = parseInt(t) : t instanceof Array ? this.labels = t.join(",") : g.superSet(V, this, "dataSource", t)
            }), e
        }(V),
        lt = function(i) {
            function e(t, i) {
                this._value = null, e.__super.call(this, t, i = void 0 === i ? "" : i)
            }
            h(e, "laya.ui.Radio", i);
            var t = e.prototype;
            return t.destroy = function(t) {
                i.prototype.destroy.call(this, t = void 0 === t ? !0 : t), this._value = null
        ...
        ct = function(t) {
            ...
            return g.imps(e, {
                ...
                this.addChild(this._list = new et), this._list.renderHandler = u.create(this, this.renderItem, null, !1), this._list.repeatX = 1, this._list.on("change", this, this.onListChange)
            }, e.onListChange = function(t) {
                this.event("change")
            }, e.getArray = function() {
                var t, i, e = [];
                for (i in this._source) t = this._source[i], this.getParentOpenStatus(t) && (t.x = this._spaceLeft * this.getDepth(t), e.push(t));
                return e
                ...
                if (!s) {
                    var o, r = {},
                        a = t.attributes;
                    for (o in a) {
                        var l = (c = a[o]).nodeName,
                            c = c.nodeValue;
                        r[l] = "true" == c || "false" != c && c
                    }
                    r.nodeParent = e, 0 < h && (r.isDirectory = !0), r.hasChild = 0 < h, i.push(r)
                }
                for (var u = 0; u < h; u++) {
                    var _ = n[u];
                    this.parseXml(_, i, r, !1)
                }
                ...
                var i;
                Boolean(t) ? (this.getFilterSource(this._source, i = [], t), this._list.array = i) : this._list.array = this.getArray()
            }, e.getFilterSource = function(t, i, e) {
                var s, n;
                for (n in e = e.toLocaleLowerCase(), t) !(s = t[n]).isDirectory && -1 < String(s.label).toLowerCase().indexOf(e) && (s.x = 0, i.push(s)), s.child && 0 < s.child.length && this.getFilterSource(s.child, i, e)
            }, o(0, e, "spaceBottom", function() {
                return this._list.spaceY
            }, function(t) {
                this._list.spaceY = t
            }), o(0, e, "keepStatus", function() {
            ...
            }), o(0, e, "mouseHandler", function() {
                return this._list.mouseHandler
            }, function(t) {
                this._list.mouseHandler = t
            }), o(0, e, "dataSource", t.prototype._$get_dataSource, function(t) {
                this._dataSource = t, g.superSet(V, this, "dataSource", t)
            }), o(0, e, "source", function() {
                return this._source
            }), o(0, e, "scrollBar", function() {
                return this._list.scrollBar
            }), o(0, e, "list", function() {
                return this._list
            }), o(0, e, "scrollBarSkin", function() {
                return this._list.vScrollBarSkin
            }, function(t) {
                this._list.vScrollBarSkin = t
            }), o(0, e, "renderHandler", function() {
                ...
                g.superSet(V, this, "width", t), this._list.width = t
            }), o(0, e, "height", t.prototype._$get_height, function(t) {
                g.superSet(V, this, "height", t), this._list.height = t
            }), o(0, e, "xml", null, function(t) {
                var i = [];
                this.parseXml(t.childNodes[0], i, null, !0), this.array = i
            }), o(0, e, "selectedPath", function() {
                return this._list.selectedItem ? this._list.selectedItem.path : null
            }), i
        }(V),
        ut = function(t) {
            function i() {
                this._items = null, this._selectedIndex = 0, i.__super.call(this), this._setIndexHandler = u.create(this, this.setIndex, null, !1)
            }
            ...
            return g.imps(e, {
                ...
                this.selectedIndex = this._items.indexOf(t)
            }), o(0, e, "items", function() {
                return this._items
            }), o(0, e, "setIndexHandler", function() {
                return this._setIndexHandler
            }, function(t) {
                this._setIndexHandler = t
            }), i
        }(V),
        _t = (h(dt, "laya.ui.VScrollBar", j), dt);

    function dt() {
        dt.__super.call(this)
    }
    var ft = function(i) {
            function e(t) {
                this._bg = null, this._skin = null, e.__super.call(this), this.text = t = void 0 === t ? "" : t, this.skin = this.skin
            }
            h(e, "laya.ui.TextInput", i);
            var t = e.prototype;
            return t.preinitialize = function() {
                this.mouseEnabled = !0
            }, t.destroy = function(t) {
                i.prototype.destroy.call(this, t = void 0 === t ? !0 : t), this._bg && this._bg.destroy(), this._bg = null
            }, t.createChildren = function() {
                this.addChild(this._tf = new f), this._tf.padding = z.inputLabelPadding, this._tf.on("input", this, this._onInput), this._tf.on("enter", this, this._onEnter), this._tf.on("blur", this, this._onBlur), this._tf.on("focus", this, this._onFocus)
            }, t._onFocus = function() {
            ...
            }, o(0, t, "text", i.prototype._$get_text, function(t) {
                this._tf.text != t && (this._tf.text = t += "", this.event("change"))
            }), o(0, t, "bg", function() {
                return this._bg
            }, function(t) {
                this.graphics = this._bg = t
            }), o(0, t, "inputElementYAdjuster", function() {
                return this._tf.inputElementYAdjuster
            }, function(t) {
                this._tf.inputElementYAdjuster = t
            }), o(0, t, "multiline", function() {
                ...
                this._skin != t && (this._skin = t, this._bg || (this.graphics = this._bg = new N), this._bg.source = m.getRes(this._skin), this._width && (this._bg.width = this._width), this._height && (this._bg.height = this._height))
            }), o(0, t, "sizeGrid", function() {
                return this._bg && this._bg.sizeGrid ? this._bg.sizeGrid.join(",") : null
            }, function(t) {
                this._bg || (this.graphics = this._bg = new N), this._bg.sizeGrid = H.fillArray(z.defaultSizeGrid, t, Number)
            }), o(0, t, "inputElementXAdjuster", function() {
                return this._tf.inputElementXAdjuster
            }, function(t) {
                this._tf.inputElementXAdjuster = t
            }), o(0, t, "width", i.prototype._$get_width, function(t) {
                g.superSet(J, this, "width", t), this._bg && (this._bg.width = t)
            }), o(0, t, "height", i.prototype._$get_height, function(t) {
                g.superSet(J, this, "height", t), this._bg && (this._bg.height = t)
            }), o(0, t, "editable", function() {
                return this._tf.editable
            }, function(t) {
                this._tf.editable = t
            }), o(0, t, "restrict", function() {
                return this._tf.restrict
            }, function(t) {
                this._tf.restrict = t
            }), o(0, t, "prompt", function() {
                return this._tf.prompt
            }, function(t) {
                this._tf.prompt = t
            }), o(0, t, "promptColor", function() {
                return this._tf.promptColor
            }, function(t) {
                this._tf.promptColor = t
            }), o(0, t, "maxChars", function() {
                return this._tf.maxChars
            }, function(t) {
                this._tf.maxChars = t
            }), o(0, t, "focus", function() {
                ...
                this._tf.type = t
            }), o(0, t, "asPassword", function() {
                return this._tf.asPassword
            }, function(t) {
                this._tf.asPassword = t
            }), e
        }(J),
        gt = (h(pt, "laya.ui.VSlider", q), pt);

    function pt() {
        pt.__super.call(this)
    }
    var mt = function(t) {
            function s() {
            ...
            }, o(0, i, "dragArea", function() {
                return this._dragArea ? this._dragArea.toString() : null
            }, function(t) {
                t ? (t = H.fillArray([0, 0, 0, 0], t, Number), this._dragArea = new C(t[0], t[1], t[2], t[3]), this.on("mousedown", this, this._onMouseDown)) : (this._dragArea = null, this.off("mousedown", this, this._onMouseDown))
            }), o(0, i, "isPopup", function() {
                return null != this.parent
            }), o(0, i, "zOrder", t.prototype._$get_zOrder, function(t) {
                g.superSet(Z, this, "zOrder", t), s.manager._checkMask()
            }), o(1, s, "manager", function() {
                return s._manager = s._manager || new E
            }, function(t) {
                s._manager = t
        ...
        yt = function(t) {
            ...
            return e.sortItem = function(t) {
                ...
                for (var t = [], i = 0, e = 0, s = this.numChildren; e < s; e++) {
                    ...
                    n && n.layoutEnabled && (t.push(n), i = this._height || Math.max(i, n.height * n.scaleY))
                }
                this.sortItem(t);
                for (var h = 0, e = 0, s = t.length; e < s; e++)(n = t[e]).x = h, h += n.width * n.scaleX + this._space, "top" == this._align ? n.y = 0 : "middle" == this._align ? n.y = .5 * (i - n.height * n.scaleY) : "bottom" == this._align && (n.y = i - n.height * n.scaleY);
                this.changeSize()
            }, o(0, e, "height", t.prototype._$get_height, function(t) {
                this._height != t && (g.superSet(tt, this, "height", t), this.callLater(this.changeItems))
        ...
        t = function() {
            ...
            function a(t) {
                this.gameStopHD = !1, this.iconImgTl = null, this._iconImage = null, this._moreBox = null, this._gameBox = null, this.screenType = 0, this._moreGameDataUrl = "https://abc.layabox.com/public/more/gamelist2.json", this._iconImageObj = null, this.clickCallBack = null, this.closeCallBack = null, this.isShow = !1, this.dinfo = null, this.ErrorUrlHttps = "https://elastic.layabox.com/", this.tongjiType = "bdm", void 0 === t && (t = 0), a.__super.call(this), this.screenType = t, this.init()
            }
            h(a, "laya.ui.MoreGame", Z);
            var t = a.prototype;
            return t.getLocalDateString = function(t) {
                t = this.getDateByTimestamp(t = void 0 === t ? 0 : t).toLocaleDateString();
                (l.onLimixiu || l.onMiniGame) && (i = new Date, t = a.toLocaleDateString(i.getTime()));
                var i = new RegExp("/", "g");
                return t = t.replace(i, "-")
            }, t.getDateByTimestamp = function(t) {
                return (t = void 0 === t ? 0 : t) && "" != t ? new Date(t) : new Date
            }, t.reportError = function(t, i, e) {
                void 0 === i && (i = ""), e = e || {};
                var s = Date.now(),
                    s = new Date(s + 0);
                e.date = s.toLocaleString(), "error" != (e.etype = t) && "statistics" != t && (t = "statistics"), e.version = "V0.0.1", e.gameId = 10100, e.dinfo = this.dinfo, e.channel = -1e3, e.msg = i, e["@timestamp"] = s.toISOString(), e.user = this.getUserId(), e.openid = this.getOpenId();
                i = a.getDay(s);
                e.rdate = i, e.day = s.getDate() + "", e.hour = s.getHours() + "", e.minute = s.getMinutes() + "", e.gameurl = n.baseURI, e.regTime = 0, "error" == t ? this.sendLog(e, this.tongjiType + "error-" + i.substring(0, 6) + "/" + t + "/", t) : this.sendLog(e, this.tongjiType + "-" + i.substring(0, 6) + "/" + t + "/", t)
                ...
                return t
            }, t.sendLog = function(t, i, e) {
                var s = this,
                    n = new d;
                n.on("error", this, function(t, i, e) {
                    e && -1 != e.indexOf("[404]") && (new d).send(s.ErrorUrlHttps + "garbage/" + i + "/", JSON.stringify(t), "post", "text", ["Content-Type", "application/json"])
                ...
                var t = Math.min(g.stage.width / g.stage.designWidth, g.stage.height / g.stage.designHeight);
                g.stage.width < 720 && (t = .9), this._moreBox && this._moreBox.scale(t, t), this._gameBox && this._gameBox.scale(t, t)
            }, t.tada = function(t, i, e, s) {
                ...
                this.removeEvent(), this.gameStopHD = !0, a._moreGameData = null, this._iconImageObj = null, this.clickCallBack = null, this.closeCallBack = null, this.iconImgTl && (this.iconImgTl.offAll("complete"), this.iconImgTl = null), this._moreBox && (this._moreBox.removeChildren(), this._moreBox = null), this._gameBox && (this._gameBox.removeChildren(), this._gameBox = null), this._iconImage && (this._iconImage.removeSelf(), this._iconImage = null)
            }, t.onSetIconType = function(t) {
                ...
                if (this.parent) {
                    ...
                    g.timer.once(1e3, this, this.onYanChiPlay)
                ...
                t != i ? (y.setItem("currentTime", i), this.reportError(a._moreGameData.statid1)) : this.reportError(a._moreGameData.statid2), this.onResLoaded()
            }, t.onResLoaded = function() {
                if (this._moreBox) this._moreBox.visible = !0;
                else {
                    this._moreBox = new V, g.stage.addChild(this._moreBox), this._moreBox.zOrder = 99999, this._moreBox.left = this._moreBox.right = this._moreBox.top = this._moreBox.bottom = 0;
                    var i = this.onCreateImage(a.onGetAtlasDanImgUrl("img_white_bg"), this._moreBox);
                    i.top = i.left = i.right = i.bottom = 0, i.sizeGrid = "1,1,1,1,1";
                    i = this.onCreateImage(a.onGetAtlasDanImgUrl("hengfengexian"), this._moreBox);
                    i.left = i.right = 0, i.y = 132, i.alpha = .2;
                    i = this.onCreateImage(a.onGetAtlasDanImgUrl("img_font_jingcai"), this._moreBox);
                    i.on("click", this, this.onJiantouImgClick), this.isQMP() && this.screenType ? i.pos(15, 70) : i.pos(15, 45);
                    i = new et;
                    this._moreBox.addChild(i), i.itemRender = r, i.selectEnable = !0, i.vScrollBarSkin = "", i.scrollBar.autoHide = !0, i.scrollBar.elasticDistance = 250, i.renderHandler = new u(this, this.onGameListRender);
                    var t = a._moreGameData.marvellousGame.gameList,
                        e = [];
                    e.push(t[0]), e.push(t[1]);
                    var s = this.RandomNumBoth(e.length, t.length - e.length, t.length);
                    if (s) {
                        try {
                            ...
                            a._moreGameData.marvellousGame.gameList = [], a._moreGameData.marvellousGame.gameList = e, i.array = a._moreGameData.marvellousGame.gameList
                        } catch (t) {
                            i.array = a._moreGameData.marvellousGame.gameList
                        }
                        this.screenType && (i.spaceY = 10, i.width = 690, this.isQMP() ? i.height = g.stage.height + 130 : i.height = 1139, i.y = 139, i.centerX = 0), this.onStageResize()
                    } else this.visible = !1
                }
            }, t.RandomNumBoth = function(t, i, e) {
                for (var s = [], n = t; n < e; n++) s.push(n);
                for (var h = [], o = s.length, n = 0; n < o; n++) {
                    s.length;
                ...
                var t = !1,
                    i = 0,
                    i = "horizontal" == g.stage.screenMode ? l.height % 9 : l.width % 9;
                l.onAndroid && 0 == i && (e = 0, e = "horizontal" == g.stage.screenMode ? l.width : l.height, -1 != [2280, 2160, 2244, 3120, 2248, 2340, 2310].indexOf(e) && (t = !0));
                var i = /iPhone/gi.test(l.window.navigator.userAgent) && 375 == Math.min(l.clientHeight, l.clientWidth) && 812 == Math.max(l.clientHeight, l.clientWidth),
                    e = 414 == Math.min(l.clientHeight, l.clientWidth) && 896 == Math.max(l.clientHeight, l.clientWidth);
                return t = (l.onMiniGame || l.onBDMiniGame) && !l.onAndroid && (i || e) ? !0 : t
            }, t.onDrawShapes = function(t, i, e, s) {
                var n = e = void 0 === e ? 5 : e;
                (s = void 0 === s ? !1 : s) && (n = 0);
                s = new S;
                return s.graphics.drawPath(0, 0, [
                    ["moveTo", e, 0],
                    ["lineTo", 105, 0],
                    ["arcTo", t, 0, t, e, e],
                    ["lineTo", t, i],
            ...
            }, t.onCreateMaskImg = function(t, i) {
                var e = this.onCreateImage(a.onGetAtlasDanImgUrl("dayuan"), i),
                    i = this.onCreateImage(t, e);
                i.pos(11, 10);
                t = new S;
                return t.graphics.drawCircle(71, 74, 68, "#ff0000"), i.mask = t, e.scale(.7, .7), e
            }, t.onGameListRender = function(t, i) {
                var e = a._moreGameData.marvellousGame.gameList;
                i < 0 || i > e.length - 1 || (i = e[i], t.init(i, this.screenType, new u(this, this.onItemClickCallBack)))
            }, t.onItemClickCallBack = function(i) {
                var t, e, s, n = this;
                swan.navigateToMiniProgram && (t = i.appKey, e = i.path, s = i.extendInfo, swan.navigateToMiniProgram({
                    appKey: t,
                    path: e,
                    extraData: s,
                    success: function(t) {},
                ...
                var i = this,
                    t = this.randRange(1e4, 1e6),
                    t = this._moreGameDataUrl + "?" + t;
                a._http.open("get", t, !0), a._http.setRequestHeader("Content-Type", "application/x-www-form-urlencoded"), a._http.responseType = "text", a._http.onerror = function(t) {
                    i._onError(t)
                }, a._http.onload = function(t) {
                    i._onLoad(t)
                }, a._http.send(null)
            }, t._onError = function(t) {
            ...
            }, a.getDateFormatStr = function(t, i) {
                void 0 === i && (i = "yynndd");
                var e = new Date(t),
                    s = e.getFullYear(),
                    n = e.getMonth() + 1,
                ...
                return s.toString() + "年" + n.toString() + "月" + h.toString() + "日" + o.toString() + "时" + t.toString() + "分" + e.toString() + "秒"
            }, a.getDay = function(t) {
                var i = t.getMonth() + 1,
                    e = t.getDate();
            ...
            }, a._moreGameData = null, s(a, ["_http", function() {
                return this._http = new l.window.XMLHttpRequest
            }]), a.__init$ = function() {
                r = function() {
                    function t() {
                        this.titleLabel = null, this.gameListBox = null, t.__super.call(this)
                    }
                    h(t, "", V);
                    var i = t.prototype;
                    return i.init = function(t, i, e) {
                        if (this.titleLabel ? this.titleLabel.text = t.title : (this.titleLabel = this.onCreateLabel(t.title, this, 32, "#3d3939"), this.titleLabel.pos(8, 0), this.titleLabel.size(162, 50)), this.gameListBox)
                            for (s = 0, n = this.gameListBox._childs.length; s < n; s++)(h = this.gameListBox._childs[s]).init(t.gameList[s], i, e);
                        else {
                    ...
                    function t() {
                        this.kuangImg = null, this.iconNameLabel = null, this.iconImg = null, this.playImg = null, this.itemData = null, this.callBackHandler = null, t.__super.call(this)
                    }
                    h(t, "", V);
                    var i = t.prototype;
        ...
        vt = function(t) {
            ...
            return e.changeItems = function() {
                ...
                for (var t = [], i = 0, e = 0, s = this.numChildren; e < s; e++) {
                    var n = this.getChildAt(e);
                    n && n.layoutEnabled && (t.push(n), i = this._width || Math.max(i, n.width * n.scaleX))
                }
                this.sortItem(t);
                for (var h = 0, e = 0, s = t.length; e < s; e++)(n = t[e]).y = h, h += n.height * n.scaleY + this._space, "left" == this._align ? n.x = 0 : "center" == this._align ? n.x = .5 * (i - n.width * n.scaleX) : "right" == this._align && (n.x = i - n.width * n.scaleX);
                this.changeSize()
            }, o(0, e, "width", t.prototype._$get_width, function(t) {
                this._width != t && (g.superSet(tt, this, "width", t), this.callLater(this.changeItems))
            }), i.NONE = "none", i.LEFT = "left", i.CENTER = "center", i.RIGHT = "right", i
        }(tt),
        Ct = (h(bt, "laya.ui.RadioGroup", at), bt.prototype.createItem = function(t, i) {
            return new lt(t, i)
        }, bt);

    function bt() {
        bt.__super.call(this)
    }
    var St = (h(xt, "laya.ui.Tab", at), xt.prototype.createItem = function(t, i) {
        return new W(t, i)
    }, xt);

    function xt() {
        xt.__super.call(this)
    }
    var wt = function(i) {
        function e(t) {
            this._vScrollBar = null, this._hScrollBar = null, e.__super.call(this, t = void 0 === t ? "" : t)
        }
        h(e, "laya.ui.TextArea", i);
        var t = e.prototype;
        return t.destroy = function(t) {
            i.prototype.destroy.call(this, t = void 0 === t ? !0 : t), this._vScrollBar && this._vScrollBar.destroy(), this._hScrollBar && this._hScrollBar.destroy(), this._vScrollBar = null, this._hScrollBar = null
        }, t.initialize = function() {
            ...
            var t = this._vScrollBar && 0 < this._tf.maxScrollY,
                ...
                n = this._tf.padding || z.labelPadding;
        ...
        }, o(0, t, "scrollY", function() {
            return this._tf.scrollY
        }), o(0, t, "width", i.prototype._$get_width, function(t) {
            g.superSet(ft, this, "width", t), this.callLater(this.changeScroll)
        }), o(0, t, "hScrollBar", function() {
            return this._hScrollBar
        }), o(0, t, "height", i.prototype._$get_height, function(t) {
            g.superSet(ft, this, "height", t), this.callLater(this.changeScroll)
        }), o(0, t, "maxScrollX", function() {
            return this._tf.maxScrollX
        }), o(0, t, "vScrollBarSkin", function() {
            return this._vScrollBar ? this._vScrollBar.skin : null
        }, function(t) {
            null == this._vScrollBar && (this.addChild(this._vScrollBar = new _t), this._vScrollBar.on("change", this, this.onVBarChanged), this._vScrollBar.target = this._tf, this.callLater(this.changeScroll)), this._vScrollBar.skin = t
        }), o(0, t, "hScrollBarSkin", function() {
            return this._hScrollBar ? this._hScrollBar.skin : null
        }, function(t) {
            null == this._hScrollBar && (this.addChild(this._hScrollBar = new st), this._hScrollBar.on("change", this, this.onHBarChanged), this._hScrollBar.mouseWheelEnable = !1, this._hScrollBar.target = this._tf, this.callLater(this.changeScroll)), this._hScrollBar.skin = t
        }), o(0, t, "vScrollBar", function() {
            return this._vScrollBar
        }), o(0, t, "maxScrollY", function() {
            return this._tf.maxScrollY
        }), o(0, t, "scrollX", function() {
            return this._tf.scrollX
        }), e
    }(ft);
    ! function() {
        function t() {
            this._uiView = null, this.isCloseOther = !1, t.__super.call(this)
        }
        h(t, "laya.ui.AsynDialog", mt);
        var i = t.prototype;
        i.createView = function(t) {
            this._uiView = t
        }, i._open = function(t, i, e) {
            this.isModal = t, this.isCloseOther = i, mt.manager.lock(!0), this._uiView ? this.onCreated() : this.onOpen()
            ...
            mt.manager.open(this, this.isCloseOther), mt.manager.lock(!1)
        }, i.close = function(t, i) {
            void 0 === i && (i = !0), mt.manager.close(this), this.onClose()
